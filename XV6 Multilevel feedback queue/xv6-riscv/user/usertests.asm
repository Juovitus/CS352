...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0da50513          	addi	a0,a0,218 # 6118 <malloc+0x104>
      46:	00006097          	auipc	ra,0x6
      4a:	f10080e7          	jalr	-240(ra) # 5f56 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	a9078793          	addi	a5,a5,-1392 # 9ae8 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	19868693          	addi	a3,a3,408 # c1f8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	0b850513          	addi	a0,a0,184 # 6138 <malloc+0x124>
      88:	00006097          	auipc	ra,0x6
      8c:	ece080e7          	jalr	-306(ra) # 5f56 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0a850513          	addi	a0,a0,168 # 6150 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0aa50513          	addi	a0,a0,170 # 6170 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	07250513          	addi	a0,a0,114 # 6158 <malloc+0x144>
      ee:	00006097          	auipc	ra,0x6
      f2:	e68080e7          	jalr	-408(ra) # 5f56 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	07e50513          	addi	a0,a0,126 # 6180 <malloc+0x16c>
     10a:	00006097          	auipc	ra,0x6
     10e:	e4c080e7          	jalr	-436(ra) # 5f56 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	07c50513          	addi	a0,a0,124 # 61a8 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	06850513          	addi	a0,a0,104 # 61a8 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	06458593          	addi	a1,a1,100 # 61b8 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	04050513          	addi	a0,a0,64 # 61a8 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	04458593          	addi	a1,a1,68 # 61c0 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	01450513          	addi	a0,a0,20 # 61a8 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	ffe50513          	addi	a0,a0,-2 # 61c8 <malloc+0x1b4>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d84080e7          	jalr	-636(ra) # 5f56 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f7450513          	addi	a0,a0,-140 # 61f0 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f60a8a93          	addi	s5,s5,-160 # 61f0 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	f60a0a13          	addi	s4,s4,-160 # c1f8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	eee50513          	addi	a0,a0,-274 # 6200 <malloc+0x1ec>
     31a:	00006097          	auipc	ra,0x6
     31e:	c3c080e7          	jalr	-964(ra) # 5f56 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	eea50513          	addi	a0,a0,-278 # 6220 <malloc+0x20c>
     33e:	00006097          	auipc	ra,0x6
     342:	c18080e7          	jalr	-1000(ra) # 5f56 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	ed850513          	addi	a0,a0,-296 # 6238 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	ec498993          	addi	s3,s3,-316 # 6238 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	e7850513          	addi	a0,a0,-392 # 6238 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	de858593          	addi	a1,a1,-536 # 61c0 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f2:	e6a50513          	addi	a0,a0,-406 # 6258 <malloc+0x244>
     3f6:	00006097          	auipc	ra,0x6
     3fa:	b60080e7          	jalr	-1184(ra) # 5f56 <printf>
    exit(1);
     3fe:	4505                	li	a0,1
     ...
     40c:	e3850513          	addi	a0,a0,-456 # 6240 <malloc+0x22c>
     410:	00006097          	auipc	ra,0x6
     414:	b46080e7          	jalr	-1210(ra) # 5f56 <printf>
      exit(1);
     418:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     426:	e1e50513          	addi	a0,a0,-482 # 6240 <malloc+0x22c>
     42a:	00006097          	auipc	ra,0x6
     42e:	b2c080e7          	jalr	-1236(ra) # 5f56 <printf>
    exit(1);
     432:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     44a:	df250513          	addi	a0,a0,-526 # 6238 <malloc+0x224>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	d16a0a13          	addi	s4,s4,-746 # 6268 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	c7250513          	addi	a0,a0,-910 # 6270 <malloc+0x25c>
     606:	00006097          	auipc	ra,0x6
     60a:	950080e7          	jalr	-1712(ra) # 5f56 <printf>
      exit(1);
     60e:	4505                	li	a0,1
     ...
     620:	c6c50513          	addi	a0,a0,-916 # 6288 <malloc+0x274>
     624:	00006097          	auipc	ra,0x6
     628:	932080e7          	jalr	-1742(ra) # 5f56 <printf>
      exit(1);
     62c:	4505                	li	a0,1
     ...
     63e:	c7e50513          	addi	a0,a0,-898 # 62b8 <malloc+0x2a4>
     642:	00006097          	auipc	ra,0x6
     646:	914080e7          	jalr	-1772(ra) # 5f56 <printf>
      exit(1);
     64a:	4505                	li	a0,1
     ...
     658:	c9450513          	addi	a0,a0,-876 # 62e8 <malloc+0x2d4>
     65c:	00006097          	auipc	ra,0x6
     660:	8fa080e7          	jalr	-1798(ra) # 5f56 <printf>
      exit(1);
     664:	4505                	li	a0,1
     ...
     676:	c8650513          	addi	a0,a0,-890 # 62f8 <malloc+0x2e4>
     67a:	00006097          	auipc	ra,0x6
     67e:	8dc080e7          	jalr	-1828(ra) # 5f56 <printf>
      exit(1);
     682:	4505                	li	a0,1
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	c78a0a13          	addi	s4,s4,-904 # 6328 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	b08a8a93          	addi	s5,s5,-1272 # 61c0 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	bd250513          	addi	a0,a0,-1070 # 6330 <malloc+0x31c>
     766:	00005097          	auipc	ra,0x5
     76a:	7f0080e7          	jalr	2032(ra) # 5f56 <printf>
      exit(1);
     76e:	4505                	li	a0,1
     ...
     780:	bcc50513          	addi	a0,a0,-1076 # 6348 <malloc+0x334>
     784:	00005097          	auipc	ra,0x5
     788:	7d2080e7          	jalr	2002(ra) # 5f56 <printf>
      exit(1);
     78c:	4505                	li	a0,1
     ...
     79a:	b5250513          	addi	a0,a0,-1198 # 62e8 <malloc+0x2d4>
     79e:	00005097          	auipc	ra,0x5
     7a2:	7b8080e7          	jalr	1976(ra) # 5f56 <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     ...
     7b4:	bc850513          	addi	a0,a0,-1080 # 6378 <malloc+0x364>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	79e080e7          	jalr	1950(ra) # 5f56 <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     ...
     7d2:	bc250513          	addi	a0,a0,-1086 # 6390 <malloc+0x37c>
     7d6:	00005097          	auipc	ra,0x5
     7da:	780080e7          	jalr	1920(ra) # 5f56 <printf>
      exit(1);
     7de:	4505                	li	a0,1
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	99458593          	addi	a1,a1,-1644 # 61b8 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	96850513          	addi	a0,a0,-1688 # 61a8 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	93c50513          	addi	a0,a0,-1732 # 61a8 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	92850513          	addi	a0,a0,-1752 # 61a8 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	b6258593          	addi	a1,a1,-1182 # 6420 <malloc+0x40c>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	8a850513          	addi	a0,a0,-1880 # 61a8 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	a7c50513          	addi	a0,a0,-1412 # 63c0 <malloc+0x3ac>
     94c:	00005097          	auipc	ra,0x5
     950:	60a080e7          	jalr	1546(ra) # 5f56 <printf>
    exit(1);
     954:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	a8050513          	addi	a0,a0,-1408 # 63e0 <malloc+0x3cc>
     968:	00005097          	auipc	ra,0x5
     96c:	5ee080e7          	jalr	1518(ra) # 5f56 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	a7c50513          	addi	a0,a0,-1412 # 63f0 <malloc+0x3dc>
     97c:	00005097          	auipc	ra,0x5
     980:	5da080e7          	jalr	1498(ra) # 5f56 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	a8050513          	addi	a0,a0,-1408 # 6410 <malloc+0x3fc>
     998:	00005097          	auipc	ra,0x5
     99c:	5be080e7          	jalr	1470(ra) # 5f56 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a4c50513          	addi	a0,a0,-1460 # 63f0 <malloc+0x3dc>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	5aa080e7          	jalr	1450(ra) # 5f56 <printf>
    exit(1);
     9b4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	a6650513          	addi	a0,a0,-1434 # 6428 <malloc+0x414>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	58c080e7          	jalr	1420(ra) # 5f56 <printf>
    exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	a6850513          	addi	a0,a0,-1432 # 6448 <malloc+0x434>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	56e080e7          	jalr	1390(ra) # 5f56 <printf>
    exit(1);
     9f0:	4505                	li	a0,1
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a5450513          	addi	a0,a0,-1452 # 6468 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	a6498993          	addi	s3,s3,-1436 # 6490 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	a94a8a93          	addi	s5,s5,-1388 # 64c8 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	9ee50513          	addi	a0,a0,-1554 # 6468 <malloc+0x454>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     a94:	0000b597          	auipc	a1,0xb
     a98:	76458593          	addi	a1,a1,1892 # c1f8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     aba:	9b250513          	addi	a0,a0,-1614 # 6468 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	99050513          	addi	a0,a0,-1648 # 6470 <malloc+0x45c>
     ae8:	00005097          	auipc	ra,0x5
     aec:	46e080e7          	jalr	1134(ra) # 5f56 <printf>
    exit(1);
     af0:	4505                	li	a0,1
     ...
     b02:	9a250513          	addi	a0,a0,-1630 # 64a0 <malloc+0x48c>
     b06:	00005097          	auipc	ra,0x5
     b0a:	450080e7          	jalr	1104(ra) # 5f56 <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     ...
     b20:	9bc50513          	addi	a0,a0,-1604 # 64d8 <malloc+0x4c4>
     b24:	00005097          	auipc	ra,0x5
     b28:	432080e7          	jalr	1074(ra) # 5f56 <printf>
      exit(1);
     b2c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	9c850513          	addi	a0,a0,-1592 # 6500 <malloc+0x4ec>
     b40:	00005097          	auipc	ra,0x5
     b44:	416080e7          	jalr	1046(ra) # 5f56 <printf>
    exit(1);
     b48:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	9cc50513          	addi	a0,a0,-1588 # 6520 <malloc+0x50c>
     b5c:	00005097          	auipc	ra,0x5
     b60:	3fa080e7          	jalr	1018(ra) # 5f56 <printf>
    exit(1);
     b64:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	9c850513          	addi	a0,a0,-1592 # 6538 <malloc+0x524>
     b78:	00005097          	auipc	ra,0x5
     b7c:	3de080e7          	jalr	990(ra) # 5f56 <printf>
    exit(1);
     b80:	4505                	li	a0,1
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9b650513          	addi	a0,a0,-1610 # 6558 <malloc+0x544>
  ...
  for(i = 0; i < MAXFILE; i++){
     bb4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
     bb6:	0000b917          	auipc	s2,0xb
     bba:	64290913          	addi	s2,s2,1602 # c1f8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	96450513          	addi	a0,a0,-1692 # 6558 <malloc+0x544>
  ...
  n = 0;
     c06:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
     c08:	0000b917          	auipc	s2,0xb
     c0c:	5f090913          	addi	s2,s2,1520 # c1f8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	92450513          	addi	a0,a0,-1756 # 6560 <malloc+0x54c>
     c44:	00005097          	auipc	ra,0x5
     c48:	312080e7          	jalr	786(ra) # 5f56 <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5e:	92650513          	addi	a0,a0,-1754 # 6580 <malloc+0x56c>
     c62:	00005097          	auipc	ra,0x5
     c66:	2f4080e7          	jalr	756(ra) # 5f56 <printf>
      exit(1);
     c6a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	93250513          	addi	a0,a0,-1742 # 65a8 <malloc+0x594>
     c7e:	00005097          	auipc	ra,0x5
     c82:	2d8080e7          	jalr	728(ra) # 5f56 <printf>
    exit(1);
     c86:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca6:	8b650513          	addi	a0,a0,-1866 # 6558 <malloc+0x544>
     ...
     cd2:	8fa50513          	addi	a0,a0,-1798 # 65c8 <malloc+0x5b4>
     cd6:	00005097          	auipc	ra,0x5
     cda:	280080e7          	jalr	640(ra) # 5f56 <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ...
     cf0:	90450513          	addi	a0,a0,-1788 # 65f0 <malloc+0x5dc>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	262080e7          	jalr	610(ra) # 5f56 <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     ...
     d0e:	8fe50513          	addi	a0,a0,-1794 # 6608 <malloc+0x5f4>
     d12:	00005097          	auipc	ra,0x5
     d16:	244080e7          	jalr	580(ra) # 5f56 <printf>
      exit(1);
     d1a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	90a50513          	addi	a0,a0,-1782 # 6630 <malloc+0x61c>
     d2e:	00005097          	auipc	ra,0x5
     d32:	228080e7          	jalr	552(ra) # 5f56 <printf>
    exit(1);
     d36:	4505                	li	a0,1
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	8f450513          	addi	a0,a0,-1804 # 6648 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	90c58593          	addi	a1,a1,-1780 # 6678 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	8c050513          	addi	a0,a0,-1856 # 6648 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	8aa50513          	addi	a0,a0,-1878 # 6648 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	89450513          	addi	a0,a0,-1900 # 6648 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	8f858593          	addi	a1,a1,-1800 # 66c0 <malloc+0x6ac>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de8:	41458593          	addi	a1,a1,1044 # c1f8 <buf>
     dec:	8526                	mv	a0,s1
  ...
  if(buf[0] != 'h'){
     dfc:	0000b717          	auipc	a4,0xb
     e00:	3fc74703          	lbu	a4,1020(a4) # c1f8 <buf>
     e04:	06800793          	li	a5,104
     e08:	0af71b63          	bne	a4,a5,ebe <unlinkread+0x17e>
  if(write(fd, buf, 10) != 10){
     e0c:	4629                	li	a2,10
     e0e:	0000b597          	auipc	a1,0xb
     e12:	3ea58593          	addi	a1,a1,1002 # c1f8 <buf>
     e16:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     e34:	81850513          	addi	a0,a0,-2024 # 6648 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	80850513          	addi	a0,a0,-2040 # 6658 <malloc+0x644>
     e58:	00005097          	auipc	ra,0x5
     e5c:	0fe080e7          	jalr	254(ra) # 5f56 <printf>
    exit(1);
     e60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	81450513          	addi	a0,a0,-2028 # 6680 <malloc+0x66c>
     e74:	00005097          	auipc	ra,0x5
     e78:	0e2080e7          	jalr	226(ra) # 5f56 <printf>
    exit(1);
     e7c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	81850513          	addi	a0,a0,-2024 # 66a0 <malloc+0x68c>
     e90:	00005097          	auipc	ra,0x5
     e94:	0c6080e7          	jalr	198(ra) # 5f56 <printf>
    exit(1);
     e98:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	82450513          	addi	a0,a0,-2012 # 66c8 <malloc+0x6b4>
     eac:	00005097          	auipc	ra,0x5
     eb0:	0aa080e7          	jalr	170(ra) # 5f56 <printf>
    exit(1);
     eb4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	82850513          	addi	a0,a0,-2008 # 66e8 <malloc+0x6d4>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	08e080e7          	jalr	142(ra) # 5f56 <printf>
    exit(1);
     ed0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	82c50513          	addi	a0,a0,-2004 # 6708 <malloc+0x6f4>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	072080e7          	jalr	114(ra) # 5f56 <printf>
    exit(1);
     eec:	4505                	li	a0,1
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	73858593          	addi	a1,a1,1848 # 6678 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	7d058593          	addi	a1,a1,2000 # 6730 <malloc+0x71c>
     f68:	00005517          	auipc	a0,0x5
     f6c:	7c050513          	addi	a0,a0,1984 # 6728 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f80:	7ac50513          	addi	a0,a0,1964 # 6728 <malloc+0x714>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	79a50513          	addi	a0,a0,1946 # 6728 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	78c50513          	addi	a0,a0,1932 # 6730 <malloc+0x71c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     fba:	660d                	lui	a2,0x3
     fbc:	0000b597          	auipc	a1,0xb
     fc0:	23c58593          	addi	a1,a1,572 # c1f8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	75458593          	addi	a1,a1,1876 # 6730 <malloc+0x71c>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	73e50513          	addi	a0,a0,1854 # 6730 <malloc+0x71c>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	72658593          	addi	a1,a1,1830 # 6728 <malloc+0x714>
    100a:	00005517          	auipc	a0,0x5
    100e:	72650513          	addi	a0,a0,1830 # 6730 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	70a58593          	addi	a1,a1,1802 # 6728 <malloc+0x714>
    1026:	00006517          	auipc	a0,0x6
    102a:	81250513          	addi	a0,a0,-2030 # 6838 <malloc+0x824>
    ...
    104c:	6f050513          	addi	a0,a0,1776 # 6738 <malloc+0x724>
    1050:	00005097          	auipc	ra,0x5
    1054:	f06080e7          	jalr	-250(ra) # 5f56 <printf>
    exit(1);
    1058:	4505                	li	a0,1
    ...
    1068:	6ec50513          	addi	a0,a0,1772 # 6750 <malloc+0x73c>
    106c:	00005097          	auipc	ra,0x5
    1070:	eea080e7          	jalr	-278(ra) # 5f56 <printf>
    exit(1);
    1074:	4505                	li	a0,1
    ...
    1084:	6e850513          	addi	a0,a0,1768 # 6768 <malloc+0x754>
    1088:	00005097          	auipc	ra,0x5
    108c:	ece080e7          	jalr	-306(ra) # 5f56 <printf>
    exit(1);
    1090:	4505                	li	a0,1
    ...
    10a0:	6ec50513          	addi	a0,a0,1772 # 6788 <malloc+0x774>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	eb2080e7          	jalr	-334(ra) # 5f56 <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    ...
    10bc:	70050513          	addi	a0,a0,1792 # 67b8 <malloc+0x7a4>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	e96080e7          	jalr	-362(ra) # 5f56 <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    ...
    10d8:	6fc50513          	addi	a0,a0,1788 # 67d0 <malloc+0x7bc>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	e7a080e7          	jalr	-390(ra) # 5f56 <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    ...
    10f4:	6f850513          	addi	a0,a0,1784 # 67e8 <malloc+0x7d4>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	e5e080e7          	jalr	-418(ra) # 5f56 <printf>
    exit(1);
    1100:	4505                	li	a0,1
    ...
    1110:	70450513          	addi	a0,a0,1796 # 6810 <malloc+0x7fc>
    1114:	00005097          	auipc	ra,0x5
    1118:	e42080e7          	jalr	-446(ra) # 5f56 <printf>
    exit(1);
    111c:	4505                	li	a0,1
    ...
    112c:	71850513          	addi	a0,a0,1816 # 6840 <malloc+0x82c>
    1130:	00005097          	auipc	ra,0x5
    1134:	e26080e7          	jalr	-474(ra) # 5f56 <printf>
    exit(1);
    1138:	4505                	li	a0,1
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	70698993          	addi	s3,s3,1798 # 6860 <malloc+0x84c>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	6da50513          	addi	a0,a0,1754 # 6870 <malloc+0x85c>
    119e:	00005097          	auipc	ra,0x5
    11a2:	db8080e7          	jalr	-584(ra) # 5f56 <printf>
      exit(1);
    11a6:	4505                	li	a0,1
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	694a0a13          	addi	s4,s4,1684 # 6890 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	64250513          	addi	a0,a0,1602 # 6890 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	5da50513          	addi	a0,a0,1498 # 6898 <malloc+0x884>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	c90080e7          	jalr	-880(ra) # 5f56 <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    ...
    12e2:	5da50513          	addi	a0,a0,1498 # 68b8 <malloc+0x8a4>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	c70080e7          	jalr	-912(ra) # 5f56 <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    ...
    12fe:	5de50513          	addi	a0,a0,1502 # 68d8 <malloc+0x8c4>
    1302:	00005097          	auipc	ra,0x5
    1306:	c54080e7          	jalr	-940(ra) # 5f56 <printf>
      exit(1);
    130a:	4505                	li	a0,1
...
0000000000001314 <pgbug>:
{
  ...
  exec(big, argv);
    1322:	00007497          	auipc	s1,0x7
    1326:	6ae48493          	addi	s1,s1,1710 # 89d0 <big>
...
000000000000134c <badarg>:
{
    ...
    135c:	35048493          	addi	s1,s1,848 # c350 <buf+0x158>
    argv[0] = (char*)0xffffffff;
    1360:	597d                	li	s2,-1
    1362:	02095913          	srli	s2,s2,0x20
    exec("echo", argv);
    1366:	00005997          	auipc	s3,0x5
    136a:	dea98993          	addi	s3,s3,-534 # 6150 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	74078793          	addi	a5,a5,1856 # 7b30 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    1426:	00007797          	auipc	a5,0x7
    142a:	6ba78793          	addi	a5,a5,1722 # 8ae0 <big.0>
    142e:	00008697          	auipc	a3,0x8
    1432:	6b268693          	addi	a3,a3,1714 # 9ae0 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    big[PGSIZE] = '\0';
    1444:	00008797          	auipc	a5,0x8
    1448:	68078e23          	sb	zero,1692(a5) # 9ae0 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    144c:	00007797          	auipc	a5,0x7
    1450:	10478793          	addi	a5,a5,260 # 8550 <malloc+0x253c>
    ...
    1474:	ce050513          	addi	a0,a0,-800 # 6150 <malloc+0x13c>
    ...
    148c:	4f850513          	addi	a0,a0,1272 # 6980 <malloc+0x96c>
    1490:	00005097          	auipc	ra,0x5
    1494:	ac6080e7          	jalr	-1338(ra) # 5f56 <printf>
      exit(1);
    1498:	4505                	li	a0,1
    ...
    14ac:	45050513          	addi	a0,a0,1104 # 68f8 <malloc+0x8e4>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	aa6080e7          	jalr	-1370(ra) # 5f56 <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    ...
    14cc:	45050513          	addi	a0,a0,1104 # 6918 <malloc+0x904>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	a86080e7          	jalr	-1402(ra) # 5f56 <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    ...
    14ee:	44e50513          	addi	a0,a0,1102 # 6938 <malloc+0x924>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	a64080e7          	jalr	-1436(ra) # 5f56 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    ...
    150e:	45650513          	addi	a0,a0,1110 # 6960 <malloc+0x94c>
    1512:	00005097          	auipc	ra,0x5
    1516:	a44080e7          	jalr	-1468(ra) # 5f56 <printf>
    exit(1);
    151a:	4505                	li	a0,1
    ...
    1528:	8bc50513          	addi	a0,a0,-1860 # 6de0 <malloc+0xdcc>
    152c:	00005097          	auipc	ra,0x5
    1530:	a2a080e7          	jalr	-1494(ra) # 5f56 <printf>
    exit(1);
    1534:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1572:	43a50513          	addi	a0,a0,1082 # 69a8 <malloc+0x994>
    1576:	00005097          	auipc	ra,0x5
    157a:	9e0080e7          	jalr	-1568(ra) # 5f56 <printf>
    exit(1);
    157e:	4505                	li	a0,1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	c0850513          	addi	a0,a0,-1016 # 61a8 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15ce:	bdea0a13          	addi	s4,s4,-1058 # 61a8 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	436a8a93          	addi	s5,s5,1078 # 6a08 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	39650513          	addi	a0,a0,918 # 69d8 <malloc+0x9c4>
    164a:	00005097          	auipc	ra,0x5
    164e:	90c080e7          	jalr	-1780(ra) # 5f56 <printf>
    exit(1);
    1652:	4505                	li	a0,1
    ...
    1662:	39250513          	addi	a0,a0,914 # 69f0 <malloc+0x9dc>
    1666:	00005097          	auipc	ra,0x5
    166a:	8f0080e7          	jalr	-1808(ra) # 5f56 <printf>
        exit(1);
    166e:	4505                	li	a0,1
    ...
    1680:	39c50513          	addi	a0,a0,924 # 6a18 <malloc+0xa04>
    1684:	00005097          	auipc	ra,0x5
    1688:	8d2080e7          	jalr	-1838(ra) # 5f56 <printf>
        exit(1);
    168c:	4505                	li	a0,1
    ...
    169e:	b0ea0a13          	addi	s4,s4,-1266 # 61a8 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	396a8a93          	addi	s5,s5,918 # 6a38 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	abc50513          	addi	a0,a0,-1348 # 61a8 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    170e:	2e650513          	addi	a0,a0,742 # 69f0 <malloc+0x9dc>
    1712:	00005097          	auipc	ra,0x5
    1716:	844080e7          	jalr	-1980(ra) # 5f56 <printf>
      exit(1);
    171a:	4505                	li	a0,1
    ...
    172c:	31850513          	addi	a0,a0,792 # 6a40 <malloc+0xa2c>
    1730:	00005097          	auipc	ra,0x5
    1734:	826080e7          	jalr	-2010(ra) # 5f56 <printf>
      exit(1);
    1738:	4505                	li	a0,1
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	a0078793          	addi	a5,a5,-1536 # 6150 <malloc+0x13c>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	30478793          	addi	a5,a5,772 # 6a60 <malloc+0xa4c>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	2fc50513          	addi	a0,a0,764 # 6a68 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    179e:	2ce50513          	addi	a0,a0,718 # 6a68 <malloc+0xa54>
    ...
    17ba:	2d250513          	addi	a0,a0,722 # 6a88 <malloc+0xa74>
    17be:	00004097          	auipc	ra,0x4
    17c2:	798080e7          	jalr	1944(ra) # 5f56 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	20650513          	addi	a0,a0,518 # 69d8 <malloc+0x9c4>
    17da:	00004097          	auipc	ra,0x4
    17de:	77c080e7          	jalr	1916(ra) # 5f56 <printf>
     exit(1);
    17e2:	4505                	li	a0,1
    ...
    17f2:	28250513          	addi	a0,a0,642 # 6a70 <malloc+0xa5c>
    17f6:	00004097          	auipc	ra,0x4
    17fa:	760080e7          	jalr	1888(ra) # 5f56 <printf>
      exit(1);
    17fe:	4505                	li	a0,1
    ...
    1810:	94450513          	addi	a0,a0,-1724 # 6150 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1844:	25850513          	addi	a0,a0,600 # 6a98 <malloc+0xa84>
    1848:	00004097          	auipc	ra,0x4
    184c:	70e080e7          	jalr	1806(ra) # 5f56 <printf>
      exit(1);
    1850:	4505                	li	a0,1
    ...
    1860:	25450513          	addi	a0,a0,596 # 6ab0 <malloc+0xa9c>
    1864:	00004097          	auipc	ra,0x4
    1868:	6f2080e7          	jalr	1778(ra) # 5f56 <printf>
    186c:	b7d1                	j	1830 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186e:	4581                	li	a1,0
    1870:	00005517          	auipc	a0,0x5
    1874:	1f850513          	addi	a0,a0,504 # 6a68 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	c8650513          	addi	a0,a0,-890 # 6520 <malloc+0x50c>
    18a2:	00004097          	auipc	ra,0x4
    18a6:	6b4080e7          	jalr	1716(ra) # 5f56 <printf>
    exit(1);
    18aa:	4505                	li	a0,1
    ...
    18ba:	13a50513          	addi	a0,a0,314 # 69f0 <malloc+0x9dc>
    18be:	00004097          	auipc	ra,0x4
    18c2:	698080e7          	jalr	1688(ra) # 5f56 <printf>
    exit(1);
    18c6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d4:	19850513          	addi	a0,a0,408 # 6a68 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	1ce50513          	addi	a0,a0,462 # 6ac8 <malloc+0xab4>
    1902:	00004097          	auipc	ra,0x4
    1906:	654080e7          	jalr	1620(ra) # 5f56 <printf>
    exit(1);
    190a:	4505                	li	a0,1
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    196a:	892a8a93          	addi	s5,s5,-1902 # c1f8 <buf>
      if(cc > sizeof(buf))
    ...
    1988:	87470713          	addi	a4,a4,-1932 # c1f8 <buf>
    ...
    19c0:	12450513          	addi	a0,a0,292 # 6ae0 <malloc+0xacc>
    19c4:	00004097          	auipc	ra,0x4
    19c8:	592080e7          	jalr	1426(ra) # 5f56 <printf>
    exit(1);
    19cc:	4505                	li	a0,1
    ...
    19e6:	816b0b13          	addi	s6,s6,-2026 # c1f8 <buf>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	0b650513          	addi	a0,a0,182 # 6af8 <malloc+0xae4>
    1a4a:	00004097          	auipc	ra,0x4
    1a4e:	50c080e7          	jalr	1292(ra) # 5f56 <printf>
        exit(1);
    1a52:	4505                	li	a0,1
    ...
    1a62:	0b250513          	addi	a0,a0,178 # 6b10 <malloc+0xafc>
    1a66:	00004097          	auipc	ra,0x4
    1a6a:	4f0080e7          	jalr	1264(ra) # 5f56 <printf>
}
    ...
    1a94:	09850513          	addi	a0,a0,152 # 6b28 <malloc+0xb14>
    1a98:	00004097          	auipc	ra,0x4
    1a9c:	4be080e7          	jalr	1214(ra) # 5f56 <printf>
      exit(1);
    1aa0:	4505                	li	a0,1
    ...
    1ad4:	07850513          	addi	a0,a0,120 # 6b48 <malloc+0xb34>
    1ad8:	00004097          	auipc	ra,0x4
    1adc:	47e080e7          	jalr	1150(ra) # 5f56 <printf>
    exit(1);
    1ae0:	4505                	li	a0,1
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	e9650513          	addi	a0,a0,-362 # 69d8 <malloc+0x9c4>
    1b4a:	00004097          	auipc	ra,0x4
    1b4e:	40c080e7          	jalr	1036(ra) # 5f56 <printf>
      exit(1);
    1b52:	4505                	li	a0,1
    ...
    1b62:	00250513          	addi	a0,a0,2 # 6b60 <malloc+0xb4c>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	3f0080e7          	jalr	1008(ra) # 5f56 <printf>
        exit(1);
    1b6e:	4505                	li	a0,1
    ...
    1b7e:	ffe50513          	addi	a0,a0,-2 # 6b78 <malloc+0xb64>
    1b82:	00004097          	auipc	ra,0x4
    1b86:	3d4080e7          	jalr	980(ra) # 5f56 <printf>
        exit(1);
    1b8a:	4505                	li	a0,1
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	de650513          	addi	a0,a0,-538 # 69d8 <malloc+0x9c4>
    1bfa:	00004097          	auipc	ra,0x4
    1bfe:	35c080e7          	jalr	860(ra) # 5f56 <printf>
      exit(1);
    1c02:	4505                	li	a0,1
    ...
    1c1a:	dc250513          	addi	a0,a0,-574 # 69d8 <malloc+0x9c4>
    1c1e:	00004097          	auipc	ra,0x4
    1c22:	338080e7          	jalr	824(ra) # 5f56 <printf>
        exit(1);
    1c26:	4505                	li	a0,1
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	f0850513          	addi	a0,a0,-248 # 6b98 <malloc+0xb84>
    1c98:	00004097          	auipc	ra,0x4
    1c9c:	2be080e7          	jalr	702(ra) # 5f56 <printf>
      exit(1);
    1ca0:	4505                	li	a0,1
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	ec050513          	addi	a0,a0,-320 # 6ba8 <malloc+0xb94>
    1cf0:	00004097          	auipc	ra,0x4
    1cf4:	266080e7          	jalr	614(ra) # 5f56 <printf>
      exit(1);
    1cf8:	4505                	li	a0,1
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	0aa50513          	addi	a0,a0,170 # 6de0 <malloc+0xdcc>
    1d3e:	00004097          	auipc	ra,0x4
    1d42:	218080e7          	jalr	536(ra) # 5f56 <printf>
      exit(1);
    1d46:	4505                	li	a0,1
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	00c50513          	addi	a0,a0,12 # 6de0 <malloc+0xdcc>
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	17a080e7          	jalr	378(ra) # 5f56 <printf>
      exit(1);
    1de4:	4505                	li	a0,1
    ...
    1e04:	c7050513          	addi	a0,a0,-912 # 6a70 <malloc+0xa5c>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	14e080e7          	jalr	334(ra) # 5f56 <printf>
          exit(1);
    1e10:	4505                	li	a0,1
    ...
    1e76:	d5650513          	addi	a0,a0,-682 # 6bc8 <malloc+0xbb4>
    1e7a:	00004097          	auipc	ra,0x4
    1e7e:	0dc080e7          	jalr	220(ra) # 5f56 <printf>
            exit(1);
    1e82:	4505                	li	a0,1
    ...
    1eaa:	d3a50513          	addi	a0,a0,-710 # 6be0 <malloc+0xbcc>
    1eae:	00004097          	auipc	ra,0x4
    1eb2:	0a8080e7          	jalr	168(ra) # 5f56 <printf>
        exit(1);
    1eb6:	4505                	li	a0,1
    ...
    1f10:	cfc50513          	addi	a0,a0,-772 # 6c08 <malloc+0xbf4>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	042080e7          	jalr	66(ra) # 5f56 <printf>
        exit(1);
    1f1c:	4505                	li	a0,1
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	21450513          	addi	a0,a0,532 # 61c0 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	1d8a8a93          	addi	s5,s5,472 # 61c0 <malloc+0x1ac>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	c40b8b93          	addi	s7,s7,-960 # 6c30 <malloc+0xc1c>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	9dc50513          	addi	a0,a0,-1572 # 69d8 <malloc+0x9c4>
    2004:	00004097          	auipc	ra,0x4
    2008:	f52080e7          	jalr	-174(ra) # 5f56 <printf>
    exit(1);
    200c:	4505                	li	a0,1
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	b9250513          	addi	a0,a0,-1134 # 6c50 <malloc+0xc3c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	e90080e7          	jalr	-368(ra) # 5f56 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2124:	b1850513          	addi	a0,a0,-1256 # 6c38 <malloc+0xc24>
    2128:	00004097          	auipc	ra,0x4
    212c:	e2e080e7          	jalr	-466(ra) # 5f56 <printf>
    exit(1);
    2130:	4505                	li	a0,1
    ...
    2140:	b3c50513          	addi	a0,a0,-1220 # 6c78 <malloc+0xc64>
    2144:	00004097          	auipc	ra,0x4
    2148:	e12080e7          	jalr	-494(ra) # 5f56 <printf>
      exit(1);
    214c:	4505                	li	a0,1
    ...
    215c:	b3850513          	addi	a0,a0,-1224 # 6c90 <malloc+0xc7c>
    2160:	00004097          	auipc	ra,0x4
    2164:	df6080e7          	jalr	-522(ra) # 5f56 <printf>
    exit(1);
    2168:	4505                	li	a0,1
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    218e:	35098993          	addi	s3,s3,848 # c350 <buf+0x158>
    2192:	1003d937          	lui	s2,0x1003d
    2196:	090e                	slli	s2,s2,0x3
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e278>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	80050513          	addi	a0,a0,-2048 # 69d8 <malloc+0x9c4>
    21e0:	00004097          	auipc	ra,0x4
    21e4:	d76080e7          	jalr	-650(ra) # 5f56 <printf>
      exit(1);
    21e8:	4505                	li	a0,1
    ...
    21fe:	aae50513          	addi	a0,a0,-1362 # 6ca8 <malloc+0xc94>
    2202:	00004097          	auipc	ra,0x4
    2206:	d54080e7          	jalr	-684(ra) # 5f56 <printf>
      exit(1);
    220a:	4505                	li	a0,1
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	75c50513          	addi	a0,a0,1884 # 69d8 <malloc+0x9c4>
    2284:	00004097          	auipc	ra,0x4
    2288:	cd2080e7          	jalr	-814(ra) # 5f56 <printf>
      exit(1);
    228c:	4505                	li	a0,1
    ...
    22ac:	a2050513          	addi	a0,a0,-1504 # 6cc8 <malloc+0xcb4>
    22b0:	00004097          	auipc	ra,0x4
    22b4:	ca6080e7          	jalr	-858(ra) # 5f56 <printf>
      exit(1);
    22b8:	4505                	li	a0,1
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	a0850513          	addi	a0,a0,-1528 # 6ce0 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	9d650513          	addi	a0,a0,-1578 # 6ce0 <malloc+0xccc>
  ...
  close(fd);
    ...
    232e:	8082                	ret
    2330:	00006797          	auipc	a5,0x6
    2334:	6b078793          	addi	a5,a5,1712 # 89e0 <args.1>
    2338:	00006697          	auipc	a3,0x6
    233c:	7a068693          	addi	a3,a3,1952 # 8ad8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2340:	00005717          	auipc	a4,0x5
    2344:	9b070713          	addi	a4,a4,-1616 # 6cf0 <malloc+0xcdc>
    2348:	e398                	sd	a4,0(a5)
    for(i = 0; i < MAXARG-1; i++)
    234a:	07a1                	addi	a5,a5,8
    234c:	fed79ee3          	bne	a5,a3,2348 <bigargtest+0x7c>
    args[MAXARG-1] = 0;
    2350:	00006597          	auipc	a1,0x6
    2354:	69058593          	addi	a1,a1,1680 # 89e0 <args.1>
    2358:	0e05bc23          	sd	zero,248(a1)
    exec("echo", args);
    235c:	00004517          	auipc	a0,0x4
    2360:	df450513          	addi	a0,a0,-524 # 6150 <malloc+0x13c>
    2364:	00004097          	auipc	ra,0x4
    2368:	89a080e7          	jalr	-1894(ra) # 5bfe <exec>
    fd = open("bigarg-ok", O_CREATE);
    236c:	20000593          	li	a1,512
    2370:	00005517          	auipc	a0,0x5
    2374:	97050513          	addi	a0,a0,-1680 # 6ce0 <malloc+0xccc>
    ...
    2398:	a3c50513          	addi	a0,a0,-1476 # 6dd0 <malloc+0xdbc>
    239c:	00004097          	auipc	ra,0x4
    23a0:	bba080e7          	jalr	-1094(ra) # 5f56 <printf>
    exit(1);
    23a4:	4505                	li	a0,1
    ...
    23bc:	a3850513          	addi	a0,a0,-1480 # 6df0 <malloc+0xddc>
    23c0:	00004097          	auipc	ra,0x4
    23c4:	b96080e7          	jalr	-1130(ra) # 5f56 <printf>
    exit(1);
    23c8:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffefdf8>
    2414:	85a6                	mv	a1,s1
    2416:	00005517          	auipc	a0,0x5
    241a:	9fa50513          	addi	a0,a0,-1542 # 6e10 <malloc+0xdfc>
    241e:	00004097          	auipc	ra,0x4
    2422:	b38080e7          	jalr	-1224(ra) # 5f56 <printf>
    exit(1);
    2426:	4505                	li	a0,1
    ...
    2436:	5a650513          	addi	a0,a0,1446 # 69d8 <malloc+0x9c4>
    243a:	00004097          	auipc	ra,0x4
    243e:	b1c080e7          	jalr	-1252(ra) # 5f56 <printf>
    exit(1);
    2442:	4505                	li	a0,1
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	53850513          	addi	a0,a0,1336 # 69d8 <malloc+0x9c4>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	aae080e7          	jalr	-1362(ra) # 5f56 <printf>
    exit(1);
    24b0:	4505                	li	a0,1
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	8c450513          	addi	a0,a0,-1852 # 6de0 <malloc+0xdcc>
    2524:	00004097          	auipc	ra,0x4
    2528:	a32080e7          	jalr	-1486(ra) # 5f56 <printf>
      exit(1);
    252c:	4505                	li	a0,1
    ...
    255c:	ca0b0b13          	addi	s6,s6,-864 # c1f8 <buf>
    ...
    25d0:	86c50513          	addi	a0,a0,-1940 # 6e38 <malloc+0xe24>
    25d4:	00004097          	auipc	ra,0x4
    25d8:	982080e7          	jalr	-1662(ra) # 5f56 <printf>
            exit(1);
    25dc:	4505                	li	a0,1
    ...
    25f0:	c3450513          	addi	a0,a0,-972 # 6220 <malloc+0x20c>
    25f4:	00004097          	auipc	ra,0x4
    25f8:	962080e7          	jalr	-1694(ra) # 5f56 <printf>
            exit(1);
    25fc:	4505                	li	a0,1
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	4ac78793          	addi	a5,a5,1196 # 7b30 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26ca:	78a50513          	addi	a0,a0,1930 # 6e50 <malloc+0xe3c>
    26ce:	00004097          	auipc	ra,0x4
    26d2:	888080e7          	jalr	-1912(ra) # 5f56 <printf>
    exit(1);
    26d6:	4505                	li	a0,1
    ...
    26e8:	21450513          	addi	a0,a0,532 # 68f8 <malloc+0x8e4>
    26ec:	00004097          	auipc	ra,0x4
    26f0:	86a080e7          	jalr	-1942(ra) # 5f56 <printf>
    exit(1);
    26f4:	4505                	li	a0,1
    ...
    2706:	21650513          	addi	a0,a0,534 # 6918 <malloc+0x904>
    270a:	00004097          	auipc	ra,0x4
    270e:	84c080e7          	jalr	-1972(ra) # 5f56 <printf>
    exit(1);
    2712:	4505                	li	a0,1
    ...
    2726:	21650513          	addi	a0,a0,534 # 6938 <malloc+0x924>
    272a:	00004097          	auipc	ra,0x4
    272e:	82c080e7          	jalr	-2004(ra) # 5f56 <printf>
    exit(1);
    2732:	4505                	li	a0,1
    ...
    2744:	22050513          	addi	a0,a0,544 # 6960 <malloc+0x94c>
    2748:	00004097          	auipc	ra,0x4
    274c:	80e080e7          	jalr	-2034(ra) # 5f56 <printf>
    exit(1);
    2750:	4505                	li	a0,1
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	70450513          	addi	a0,a0,1796 # 6e90 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27c2:	6f250513          	addi	a0,a0,1778 # 6eb0 <malloc+0xe9c>
    27c6:	00003097          	auipc	ra,0x3
    27ca:	790080e7          	jalr	1936(ra) # 5f56 <printf>
    exit(1);
    27ce:	4505                	li	a0,1
    ...
    27dc:	68050513          	addi	a0,a0,1664 # 6e58 <malloc+0xe44>
    27e0:	00003097          	auipc	ra,0x3
    27e4:	776080e7          	jalr	1910(ra) # 5f56 <printf>
    exit(1);
    27e8:	4505                	li	a0,1
    ...
    27f6:	67e50513          	addi	a0,a0,1662 # 6e70 <malloc+0xe5c>
    27fa:	00003097          	auipc	ra,0x3
    27fe:	75c080e7          	jalr	1884(ra) # 5f56 <printf>
    exit(1);
    2802:	4505                	li	a0,1
    ...
    2810:	68c50513          	addi	a0,a0,1676 # 6e98 <malloc+0xe84>
    2814:	00003097          	auipc	ra,0x3
    2818:	742080e7          	jalr	1858(ra) # 5f56 <printf>
    exit(1);
    281c:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2834:	66050513          	addi	a0,a0,1632 # 6e90 <malloc+0xe7c>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	ae650513          	addi	a0,a0,-1306 # 6328 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    2870:	67450513          	addi	a0,a0,1652 # 6ee0 <malloc+0xecc>
    2874:	00003097          	auipc	ra,0x3
    2878:	6e2080e7          	jalr	1762(ra) # 5f56 <printf>
    exit(1);
    287c:	4505                	li	a0,1
    ...
    288a:	61250513          	addi	a0,a0,1554 # 6e98 <malloc+0xe84>
    288e:	00003097          	auipc	ra,0x3
    2892:	6c8080e7          	jalr	1736(ra) # 5f56 <printf>
    exit(1);
    2896:	4505                	li	a0,1
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff0df8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    290a:	60250513          	addi	a0,a0,1538 # 6f08 <malloc+0xef4>
    290e:	00003097          	auipc	ra,0x3
    2912:	648080e7          	jalr	1608(ra) # 5f56 <printf>
    exit(1);
    2916:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	5d050513          	addi	a0,a0,1488 # 6f28 <malloc+0xf14>
    2960:	00003097          	auipc	ra,0x3
    2964:	5f6080e7          	jalr	1526(ra) # 5f56 <printf>
    exit(1);
    2968:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29c0:	5cc50513          	addi	a0,a0,1484 # 6f88 <malloc+0xf74>
    29c4:	00003097          	auipc	ra,0x3
    29c8:	592080e7          	jalr	1426(ra) # 5f56 <printf>
    exit(1);
    29cc:	4505                	li	a0,1
    ...
    29e2:	56a50513          	addi	a0,a0,1386 # 6f48 <malloc+0xf34>
    29e6:	00003097          	auipc	ra,0x3
    29ea:	570080e7          	jalr	1392(ra) # 5f56 <printf>
      exit(1);
    29ee:	4505                	li	a0,1
    ...
    29fe:	56e50513          	addi	a0,a0,1390 # 6f68 <malloc+0xf54>
    2a02:	00003097          	auipc	ra,0x3
    2a06:	554080e7          	jalr	1364(ra) # 5f56 <printf>
    exit(1);
    2a0a:	4505                	li	a0,1
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f0df7>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f0df7>
  ...
  if(c != a){
    ...
    2b48:	46450513          	addi	a0,a0,1124 # 6fa8 <malloc+0xf94>
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	40a080e7          	jalr	1034(ra) # 5f56 <printf>
    exit(1);
    2b54:	4505                	li	a0,1
    ...
    2b64:	49050513          	addi	a0,a0,1168 # 6ff0 <malloc+0xfdc>
    2b68:	00003097          	auipc	ra,0x3
    2b6c:	3ee080e7          	jalr	1006(ra) # 5f56 <printf>
    exit(1);
    2b70:	4505                	li	a0,1
    ...
    2b84:	49050513          	addi	a0,a0,1168 # 7010 <malloc+0xffc>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	3ce080e7          	jalr	974(ra) # 5f56 <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2ba4:	4b050513          	addi	a0,a0,1200 # 7050 <malloc+0x103c>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	3ae080e7          	jalr	942(ra) # 5f56 <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    ...
    2bc0:	4c450513          	addi	a0,a0,1220 # 7080 <malloc+0x106c>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	392080e7          	jalr	914(ra) # 5f56 <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    ...
    2be0:	4dc50513          	addi	a0,a0,1244 # 70b8 <malloc+0x10a4>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	372080e7          	jalr	882(ra) # 5f56 <printf>
    exit(1);
    2bec:	4505                	li	a0,1
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	4ca50513          	addi	a0,a0,1226 # 70e0 <malloc+0x10cc>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	4b850513          	addi	a0,a0,1208 # 70e0 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	46c50513          	addi	a0,a0,1132 # 70e8 <malloc+0x10d4>
    2c84:	00003097          	auipc	ra,0x3
    2c88:	2d2080e7          	jalr	722(ra) # 5f56 <printf>
    exit(1);
    2c8c:	4505                	li	a0,1
    ...
    2c9c:	46850513          	addi	a0,a0,1128 # 7100 <malloc+0x10ec>
    2ca0:	00003097          	auipc	ra,0x3
    2ca4:	2b6080e7          	jalr	694(ra) # 5f56 <printf>
    exit(1);
    2ca8:	4505                	li	a0,1
    ...
    2cb8:	e2c50513          	addi	a0,a0,-468 # 6ae0 <malloc+0xacc>
    2cbc:	00003097          	auipc	ra,0x3
    2cc0:	29a080e7          	jalr	666(ra) # 5f56 <printf>
    exit(1);
    2cc4:	4505                	li	a0,1
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	43a50513          	addi	a0,a0,1082 # 7118 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d2a:	cca50513          	addi	a0,a0,-822 # 69f0 <malloc+0x9dc>
    2d2e:	00003097          	auipc	ra,0x3
    2d32:	228080e7          	jalr	552(ra) # 5f56 <printf>
    exit(1);
    2d36:	4505                	li	a0,1
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	06c50513          	addi	a0,a0,108 # 6de0 <malloc+0xdcc>
    2d7c:	00003097          	auipc	ra,0x3
    2d80:	1da080e7          	jalr	474(ra) # 5f56 <printf>
    exit(1);
    2d84:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dce:	01650513          	addi	a0,a0,22 # 6de0 <malloc+0xdcc>
    2dd2:	00003097          	auipc	ra,0x3
    2dd6:	184080e7          	jalr	388(ra) # 5f56 <printf>
    exit(1);
    2dda:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e2e:	fb650513          	addi	a0,a0,-74 # 6de0 <malloc+0xdcc>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	124080e7          	jalr	292(ra) # 5f56 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff0df7>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	e4250513          	addi	a0,a0,-446 # 6de0 <malloc+0xdcc>
    2fa6:	00003097          	auipc	ra,0x3
    2faa:	fb0080e7          	jalr	-80(ra) # 5f56 <printf>
      exit(1);
    2fae:	4505                	li	a0,1
    ...
    2ff6:	15e50513          	addi	a0,a0,350 # 6150 <malloc+0x13c>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	1c278793          	addi	a5,a5,450 # 61c0 <malloc+0x1ac>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	2c050513          	addi	a0,a0,704 # 72f0 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	10650513          	addi	a0,a0,262 # 7148 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	14850513          	addi	a0,a0,328 # 71a0 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	1a250513          	addi	a0,a0,418 # 7218 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	1f650513          	addi	a0,a0,502 # 7288 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	23c50513          	addi	a0,a0,572 # 72e0 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3126:	ffe50513          	addi	a0,a0,-2 # 7120 <malloc+0x110c>
    312a:	00003097          	auipc	ra,0x3
    312e:	e2c080e7          	jalr	-468(ra) # 5f56 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    3142:	02a50513          	addi	a0,a0,42 # 7168 <malloc+0x1154>
    3146:	00003097          	auipc	ra,0x3
    314a:	e10080e7          	jalr	-496(ra) # 5f56 <printf>
    exit(1);
    314e:	4505                	li	a0,1
    ...
    315e:	07650513          	addi	a0,a0,118 # 71d0 <malloc+0x11bc>
    3162:	00003097          	auipc	ra,0x3
    3166:	df4080e7          	jalr	-524(ra) # 5f56 <printf>
    exit(1);
    316a:	4505                	li	a0,1
    ...
    317a:	0d250513          	addi	a0,a0,210 # 7248 <malloc+0x1234>
    317e:	00003097          	auipc	ra,0x3
    3182:	dd8080e7          	jalr	-552(ra) # 5f56 <printf>
    exit(1);
    3186:	4505                	li	a0,1
    ...
    3196:	11650513          	addi	a0,a0,278 # 72a8 <malloc+0x1294>
    319a:	00003097          	auipc	ra,0x3
    319e:	dbc080e7          	jalr	-580(ra) # 5f56 <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	15250513          	addi	a0,a0,338 # 7300 <malloc+0x12ec>
    31b6:	00003097          	auipc	ra,0x3
    31ba:	da0080e7          	jalr	-608(ra) # 5f56 <printf>
    exit(1);
    31be:	4505                	li	a0,1
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	13e50513          	addi	a0,a0,318 # 7338 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	12450513          	addi	a0,a0,292 # 7348 <malloc+0x1334>
    322c:	00003097          	auipc	ra,0x3
    3230:	d2a080e7          	jalr	-726(ra) # 5f56 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	08450513          	addi	a0,a0,132 # 7338 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    32cc:	07050513          	addi	a0,a0,112 # 7338 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	f7250513          	addi	a0,a0,-142 # 7368 <malloc+0x1354>
    33fe:	00003097          	auipc	ra,0x3
    3402:	b58080e7          	jalr	-1192(ra) # 5f56 <printf>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	f8450513          	addi	a0,a0,-124 # 7398 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	f7050513          	addi	a0,a0,-144 # 7398 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	f9c50513          	addi	a0,a0,-100 # 73d8 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    3454:	fb850513          	addi	a0,a0,-72 # 7408 <malloc+0x13f4>
    ...
    3474:	f3050513          	addi	a0,a0,-208 # 73a0 <malloc+0x138c>
    3478:	00003097          	auipc	ra,0x3
    347c:	ade080e7          	jalr	-1314(ra) # 5f56 <printf>
    exit(1);
    3480:	4505                	li	a0,1
    ...
    3490:	f2c50513          	addi	a0,a0,-212 # 73b8 <malloc+0x13a4>
    3494:	00003097          	auipc	ra,0x3
    3498:	ac2080e7          	jalr	-1342(ra) # 5f56 <printf>
    exit(1);
    349c:	4505                	li	a0,1
    ...
    34ac:	f4050513          	addi	a0,a0,-192 # 73e8 <malloc+0x13d4>
    34b0:	00003097          	auipc	ra,0x3
    34b4:	aa6080e7          	jalr	-1370(ra) # 5f56 <printf>
    exit(1);
    34b8:	4505                	li	a0,1
    ...
    34c8:	f4c50513          	addi	a0,a0,-180 # 7410 <malloc+0x13fc>
    34cc:	00003097          	auipc	ra,0x3
    34d0:	a8a080e7          	jalr	-1398(ra) # 5f56 <printf>
    exit(1);
    34d4:	4505                	li	a0,1
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	ea050513          	addi	a0,a0,-352 # 7398 <malloc+0x1384>
    ...
    3510:	e8c50513          	addi	a0,a0,-372 # 7398 <malloc+0x1384>
    ...
    3524:	eb850513          	addi	a0,a0,-328 # 73d8 <malloc+0x13c4>
    ...
    3544:	49850513          	addi	a0,a0,1176 # 69d8 <malloc+0x9c4>
    3548:	00003097          	auipc	ra,0x3
    354c:	a0e080e7          	jalr	-1522(ra) # 5f56 <printf>
    exit(1);
    3550:	4505                	li	a0,1
    ...
    3560:	e4450513          	addi	a0,a0,-444 # 73a0 <malloc+0x138c>
    3564:	00003097          	auipc	ra,0x3
    3568:	9f2080e7          	jalr	-1550(ra) # 5f56 <printf>
      exit(1);
    356c:	4505                	li	a0,1
    ...
    357c:	eb050513          	addi	a0,a0,-336 # 7428 <malloc+0x1414>
    3580:	00003097          	auipc	ra,0x3
    3584:	9d6080e7          	jalr	-1578(ra) # 5f56 <printf>
      exit(1);
    3588:	4505                	li	a0,1
    ...
    3598:	e5450513          	addi	a0,a0,-428 # 73e8 <malloc+0x13d4>
    359c:	00003097          	auipc	ra,0x3
    35a0:	9ba080e7          	jalr	-1606(ra) # 5f56 <printf>
      exit(1);
    35a4:	4505                	li	a0,1
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	e6e50513          	addi	a0,a0,-402 # 7440 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	e5a50513          	addi	a0,a0,-422 # 7440 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	e6650513          	addi	a0,a0,-410 # 7460 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	e3250513          	addi	a0,a0,-462 # 7440 <malloc+0x142c>
    ...
    3632:	d7250513          	addi	a0,a0,-654 # 73a0 <malloc+0x138c>
    3636:	00003097          	auipc	ra,0x3
    363a:	920080e7          	jalr	-1760(ra) # 5f56 <printf>
    exit(1);
    363e:	4505                	li	a0,1
    ...
    364e:	dfe50513          	addi	a0,a0,-514 # 7448 <malloc+0x1434>
    3652:	00003097          	auipc	ra,0x3
    3656:	904080e7          	jalr	-1788(ra) # 5f56 <printf>
    exit(1);
    365a:	4505                	li	a0,1
    ...
    366a:	e0250513          	addi	a0,a0,-510 # 7468 <malloc+0x1454>
    366e:	00003097          	auipc	ra,0x3
    3672:	8e8080e7          	jalr	-1816(ra) # 5f56 <printf>
    exit(1);
    3676:	4505                	li	a0,1
    ...
    3686:	dfe50513          	addi	a0,a0,-514 # 7480 <malloc+0x146c>
    368a:	00003097          	auipc	ra,0x3
    368e:	8cc080e7          	jalr	-1844(ra) # 5f56 <printf>
    exit(1);
    3692:	4505                	li	a0,1
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	f1e50513          	addi	a0,a0,-226 # 75c8 <malloc+0x15b4>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	dde50513          	addi	a0,a0,-546 # 7498 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	de650513          	addi	a0,a0,-538 # 74b8 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	ede58593          	addi	a1,a1,-290 # 75c8 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	d9450513          	addi	a0,a0,-620 # 7498 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	df850513          	addi	a0,a0,-520 # 7510 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	e0850513          	addi	a0,a0,-504 # 7538 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    374c:	e2058593          	addi	a1,a1,-480 # 7568 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	e0c50513          	addi	a0,a0,-500 # 7570 <malloc+0x155c>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3780:	a7c58593          	addi	a1,a1,-1412 # c1f8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3796:	a6674703          	lbu	a4,-1434(a4) # c1f8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	e1458593          	addi	a1,a1,-492 # 75c0 <malloc+0x15ac>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	d8450513          	addi	a0,a0,-636 # 7538 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	d7050513          	addi	a0,a0,-656 # 7538 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	d5a50513          	addi	a0,a0,-678 # 7538 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	ca650513          	addi	a0,a0,-858 # 7498 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	e5250513          	addi	a0,a0,-430 # 7658 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	e6e50513          	addi	a0,a0,-402 # 7688 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	e8a50513          	addi	a0,a0,-374 # 76b8 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	d7c50513          	addi	a0,a0,-644 # 75c0 <malloc+0x15ac>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3860:	99c58593          	addi	a1,a1,-1636 # c1f8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	cba50513          	addi	a0,a0,-838 # 7538 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	eb250513          	addi	a0,a0,-334 # 7748 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	eca50513          	addi	a0,a0,-310 # 7778 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	bd250513          	addi	a0,a0,-1070 # 7498 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	bbc50513          	addi	a0,a0,-1092 # 7498 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	ba650513          	addi	a0,a0,-1114 # 7498 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	f0258593          	addi	a1,a1,-254 # 7808 <malloc+0x17f4>
    390e:	00004517          	auipc	a0,0x4
    3912:	e3a50513          	addi	a0,a0,-454 # 7748 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	ee658593          	addi	a1,a1,-282 # 7808 <malloc+0x17f4>
    392a:	00004517          	auipc	a0,0x4
    392e:	e4e50513          	addi	a0,a0,-434 # 7778 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	c8258593          	addi	a1,a1,-894 # 75c0 <malloc+0x15ac>
    3946:	00004517          	auipc	a0,0x4
    394a:	b7250513          	addi	a0,a0,-1166 # 74b8 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	dee50513          	addi	a0,a0,-530 # 7748 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	e0a50513          	addi	a0,a0,-502 # 7778 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	c3e50513          	addi	a0,a0,-962 # 75c0 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	de250513          	addi	a0,a0,-542 # 7778 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	d9e50513          	addi	a0,a0,-610 # 7748 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	afa50513          	addi	a0,a0,-1286 # 74b8 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	f8650513          	addi	a0,a0,-122 # 7958 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	bda50513          	addi	a0,a0,-1062 # 75c0 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	abe50513          	addi	a0,a0,-1346 # 74b8 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	a8a50513          	addi	a0,a0,-1398 # 7498 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	fa650513          	addi	a0,a0,-90 # 79c8 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	a6250513          	addi	a0,a0,-1438 # 7498 <malloc+0x1484>
    ...
    3a5c:	a4850513          	addi	a0,a0,-1464 # 74a0 <malloc+0x148c>
    3a60:	00002097          	auipc	ra,0x2
    3a64:	4f6080e7          	jalr	1270(ra) # 5f56 <printf>
    exit(1);
    3a68:	4505                	li	a0,1
    ...
    3a78:	a4c50513          	addi	a0,a0,-1460 # 74c0 <malloc+0x14ac>
    3a7c:	00002097          	auipc	ra,0x2
    3a80:	4da080e7          	jalr	1242(ra) # 5f56 <printf>
    exit(1);
    3a84:	4505                	li	a0,1
    ...
    3a94:	a5050513          	addi	a0,a0,-1456 # 74e0 <malloc+0x14cc>
    3a98:	00002097          	auipc	ra,0x2
    3a9c:	4be080e7          	jalr	1214(ra) # 5f56 <printf>
    exit(1);
    3aa0:	4505                	li	a0,1
    ...
    3ab0:	a6c50513          	addi	a0,a0,-1428 # 7518 <malloc+0x1504>
    3ab4:	00002097          	auipc	ra,0x2
    3ab8:	4a2080e7          	jalr	1186(ra) # 5f56 <printf>
    exit(1);
    3abc:	4505                	li	a0,1
    ...
    3acc:	a8050513          	addi	a0,a0,-1408 # 7548 <malloc+0x1534>
    3ad0:	00002097          	auipc	ra,0x2
    3ad4:	486080e7          	jalr	1158(ra) # 5f56 <printf>
    exit(1);
    3ad8:	4505                	li	a0,1
    ...
    3ae8:	a9c50513          	addi	a0,a0,-1380 # 7580 <malloc+0x156c>
    3aec:	00002097          	auipc	ra,0x2
    3af0:	46a080e7          	jalr	1130(ra) # 5f56 <printf>
    exit(1);
    3af4:	4505                	li	a0,1
    ...
    3b04:	aa050513          	addi	a0,a0,-1376 # 75a0 <malloc+0x158c>
    3b08:	00002097          	auipc	ra,0x2
    3b0c:	44e080e7          	jalr	1102(ra) # 5f56 <printf>
    exit(1);
    3b10:	4505                	li	a0,1
    ...
    3b20:	ab450513          	addi	a0,a0,-1356 # 75d0 <malloc+0x15bc>
    3b24:	00002097          	auipc	ra,0x2
    3b28:	432080e7          	jalr	1074(ra) # 5f56 <printf>
    exit(1);
    3b2c:	4505                	li	a0,1
    ...
    3b3c:	ac050513          	addi	a0,a0,-1344 # 75f8 <malloc+0x15e4>
    3b40:	00002097          	auipc	ra,0x2
    3b44:	416080e7          	jalr	1046(ra) # 5f56 <printf>
    exit(1);
    3b48:	4505                	li	a0,1
    ...
    3b58:	ac450513          	addi	a0,a0,-1340 # 7618 <malloc+0x1604>
    3b5c:	00002097          	auipc	ra,0x2
    3b60:	3fa080e7          	jalr	1018(ra) # 5f56 <printf>
    exit(1);
    3b64:	4505                	li	a0,1
    ...
    3b74:	ad050513          	addi	a0,a0,-1328 # 7640 <malloc+0x162c>
    3b78:	00002097          	auipc	ra,0x2
    3b7c:	3de080e7          	jalr	990(ra) # 5f56 <printf>
    exit(1);
    3b80:	4505                	li	a0,1
    ...
    3b90:	adc50513          	addi	a0,a0,-1316 # 7668 <malloc+0x1654>
    3b94:	00002097          	auipc	ra,0x2
    3b98:	3c2080e7          	jalr	962(ra) # 5f56 <printf>
    exit(1);
    3b9c:	4505                	li	a0,1
    ...
    3bac:	af050513          	addi	a0,a0,-1296 # 7698 <malloc+0x1684>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	3a6080e7          	jalr	934(ra) # 5f56 <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
    ...
    3bc8:	afc50513          	addi	a0,a0,-1284 # 76c0 <malloc+0x16ac>
    3bcc:	00002097          	auipc	ra,0x2
    3bd0:	38a080e7          	jalr	906(ra) # 5f56 <printf>
    exit(1);
    3bd4:	4505                	li	a0,1
    ...
    3be4:	af850513          	addi	a0,a0,-1288 # 76d8 <malloc+0x16c4>
    3be8:	00002097          	auipc	ra,0x2
    3bec:	36e080e7          	jalr	878(ra) # 5f56 <printf>
    exit(1);
    3bf0:	4505                	li	a0,1
    ...
    3c00:	afc50513          	addi	a0,a0,-1284 # 76f8 <malloc+0x16e4>
    3c04:	00002097          	auipc	ra,0x2
    3c08:	352080e7          	jalr	850(ra) # 5f56 <printf>
    exit(1);
    3c0c:	4505                	li	a0,1
    ...
    3c1c:	b0050513          	addi	a0,a0,-1280 # 7718 <malloc+0x1704>
    3c20:	00002097          	auipc	ra,0x2
    3c24:	336080e7          	jalr	822(ra) # 5f56 <printf>
    exit(1);
    3c28:	4505                	li	a0,1
    ...
    3c38:	b2450513          	addi	a0,a0,-1244 # 7758 <malloc+0x1744>
    3c3c:	00002097          	auipc	ra,0x2
    3c40:	31a080e7          	jalr	794(ra) # 5f56 <printf>
    exit(1);
    3c44:	4505                	li	a0,1
    ...
    3c54:	b3850513          	addi	a0,a0,-1224 # 7788 <malloc+0x1774>
    3c58:	00002097          	auipc	ra,0x2
    3c5c:	2fe080e7          	jalr	766(ra) # 5f56 <printf>
    exit(1);
    3c60:	4505                	li	a0,1
    ...
    3c70:	b3c50513          	addi	a0,a0,-1220 # 77a8 <malloc+0x1794>
    3c74:	00002097          	auipc	ra,0x2
    3c78:	2e2080e7          	jalr	738(ra) # 5f56 <printf>
    exit(1);
    3c7c:	4505                	li	a0,1
    ...
    3c8c:	b4050513          	addi	a0,a0,-1216 # 77c8 <malloc+0x17b4>
    3c90:	00002097          	auipc	ra,0x2
    3c94:	2c6080e7          	jalr	710(ra) # 5f56 <printf>
    exit(1);
    3c98:	4505                	li	a0,1
    ...
    3ca8:	b4450513          	addi	a0,a0,-1212 # 77e8 <malloc+0x17d4>
    3cac:	00002097          	auipc	ra,0x2
    3cb0:	2aa080e7          	jalr	682(ra) # 5f56 <printf>
    exit(1);
    3cb4:	4505                	li	a0,1
    ...
    3cc4:	b5850513          	addi	a0,a0,-1192 # 7818 <malloc+0x1804>
    3cc8:	00002097          	auipc	ra,0x2
    3ccc:	28e080e7          	jalr	654(ra) # 5f56 <printf>
    exit(1);
    3cd0:	4505                	li	a0,1
    ...
    3ce0:	b6450513          	addi	a0,a0,-1180 # 7840 <malloc+0x182c>
    3ce4:	00002097          	auipc	ra,0x2
    3ce8:	272080e7          	jalr	626(ra) # 5f56 <printf>
    exit(1);
    3cec:	4505                	li	a0,1
    ...
    3cfc:	b7050513          	addi	a0,a0,-1168 # 7868 <malloc+0x1854>
    3d00:	00002097          	auipc	ra,0x2
    3d04:	256080e7          	jalr	598(ra) # 5f56 <printf>
    exit(1);
    3d08:	4505                	li	a0,1
    ...
    3d18:	b7c50513          	addi	a0,a0,-1156 # 7890 <malloc+0x187c>
    3d1c:	00002097          	auipc	ra,0x2
    3d20:	23a080e7          	jalr	570(ra) # 5f56 <printf>
    exit(1);
    3d24:	4505                	li	a0,1
    ...
    3d34:	b8050513          	addi	a0,a0,-1152 # 78b0 <malloc+0x189c>
    3d38:	00002097          	auipc	ra,0x2
    3d3c:	21e080e7          	jalr	542(ra) # 5f56 <printf>
    exit(1);
    3d40:	4505                	li	a0,1
    ...
    3d50:	b8450513          	addi	a0,a0,-1148 # 78d0 <malloc+0x18bc>
    3d54:	00002097          	auipc	ra,0x2
    3d58:	202080e7          	jalr	514(ra) # 5f56 <printf>
    exit(1);
    3d5c:	4505                	li	a0,1
    ...
    3d6c:	b9050513          	addi	a0,a0,-1136 # 78f8 <malloc+0x18e4>
    3d70:	00002097          	auipc	ra,0x2
    3d74:	1e6080e7          	jalr	486(ra) # 5f56 <printf>
    exit(1);
    3d78:	4505                	li	a0,1
    ...
    3d88:	b9450513          	addi	a0,a0,-1132 # 7918 <malloc+0x1904>
    3d8c:	00002097          	auipc	ra,0x2
    3d90:	1ca080e7          	jalr	458(ra) # 5f56 <printf>
    exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da4:	b9850513          	addi	a0,a0,-1128 # 7938 <malloc+0x1924>
    3da8:	00002097          	auipc	ra,0x2
    3dac:	1ae080e7          	jalr	430(ra) # 5f56 <printf>
    exit(1);
    3db0:	4505                	li	a0,1
    ...
    3dc0:	ba450513          	addi	a0,a0,-1116 # 7960 <malloc+0x194c>
    3dc4:	00002097          	auipc	ra,0x2
    3dc8:	192080e7          	jalr	402(ra) # 5f56 <printf>
    exit(1);
    3dcc:	4505                	li	a0,1
    ...
    3ddc:	82050513          	addi	a0,a0,-2016 # 75f8 <malloc+0x15e4>
    3de0:	00002097          	auipc	ra,0x2
    3de4:	176080e7          	jalr	374(ra) # 5f56 <printf>
    exit(1);
    3de8:	4505                	li	a0,1
    ...
    3df8:	b8c50513          	addi	a0,a0,-1140 # 7980 <malloc+0x196c>
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	15a080e7          	jalr	346(ra) # 5f56 <printf>
    exit(1);
    3e04:	4505                	li	a0,1
    ...
    3e14:	b9050513          	addi	a0,a0,-1136 # 79a0 <malloc+0x198c>
    3e18:	00002097          	auipc	ra,0x2
    3e1c:	13e080e7          	jalr	318(ra) # 5f56 <printf>
    exit(1);
    3e20:	4505                	li	a0,1
    ...
    3e30:	ba450513          	addi	a0,a0,-1116 # 79d0 <malloc+0x19bc>
    3e34:	00002097          	auipc	ra,0x2
    3e38:	122080e7          	jalr	290(ra) # 5f56 <printf>
    exit(1);
    3e3c:	4505                	li	a0,1
    ...
    3e4c:	ba850513          	addi	a0,a0,-1112 # 79f0 <malloc+0x19dc>
    3e50:	00002097          	auipc	ra,0x2
    3e54:	106080e7          	jalr	262(ra) # 5f56 <printf>
    exit(1);
    3e58:	4505                	li	a0,1
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	b9a50513          	addi	a0,a0,-1126 # 7a08 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	b8850513          	addi	a0,a0,-1144 # 7a08 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	9a650513          	addi	a0,a0,-1626 # 6838 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	5bc50513          	addi	a0,a0,1468 # 7460 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	55250513          	addi	a0,a0,1362 # 7408 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	ba850513          	addi	a0,a0,-1112 # 7a70 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	bbe50513          	addi	a0,a0,-1090 # 7a98 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	b1c50513          	addi	a0,a0,-1252 # 7a08 <malloc+0x19f4>
    ...
    3f0e:	b0650513          	addi	a0,a0,-1274 # 7a10 <malloc+0x19fc>
    3f12:	00002097          	auipc	ra,0x2
    3f16:	044080e7          	jalr	68(ra) # 5f56 <printf>
    exit(1);
    3f1a:	4505                	li	a0,1
    ...
    3f2a:	b0250513          	addi	a0,a0,-1278 # 7a28 <malloc+0x1a14>
    3f2e:	00002097          	auipc	ra,0x2
    3f32:	028080e7          	jalr	40(ra) # 5f56 <printf>
    exit(1);
    3f36:	4505                	li	a0,1
    ...
    3f46:	afe50513          	addi	a0,a0,-1282 # 7a40 <malloc+0x1a2c>
    3f4a:	00002097          	auipc	ra,0x2
    3f4e:	00c080e7          	jalr	12(ra) # 5f56 <printf>
    exit(1);
    3f52:	4505                	li	a0,1
    ...
    3f62:	afa50513          	addi	a0,a0,-1286 # 7a58 <malloc+0x1a44>
    3f66:	00002097          	auipc	ra,0x2
    3f6a:	ff0080e7          	jalr	-16(ra) # 5f56 <printf>
    exit(1);
    3f6e:	4505                	li	a0,1
    ...
    3f7e:	49650513          	addi	a0,a0,1174 # 7410 <malloc+0x13fc>
    3f82:	00002097          	auipc	ra,0x2
    3f86:	fd4080e7          	jalr	-44(ra) # 5f56 <printf>
    exit(1);
    3f8a:	4505                	li	a0,1
    ...
    3f9a:	ae250513          	addi	a0,a0,-1310 # 7a78 <malloc+0x1a64>
    3f9e:	00002097          	auipc	ra,0x2
    3fa2:	fb8080e7          	jalr	-72(ra) # 5f56 <printf>
    exit(1);
    3fa6:	4505                	li	a0,1
    ...
    3fb6:	aee50513          	addi	a0,a0,-1298 # 7aa0 <malloc+0x1a8c>
    3fba:	00002097          	auipc	ra,0x2
    3fbe:	f9c080e7          	jalr	-100(ra) # 5f56 <printf>
    exit(1);
    3fc2:	4505                	li	a0,1
    ...
    3fd2:	af250513          	addi	a0,a0,-1294 # 7ac0 <malloc+0x1aac>
    3fd6:	00002097          	auipc	ra,0x2
    3fda:	f80080e7          	jalr	-128(ra) # 5f56 <printf>
    exit(1);
    3fde:	4505                	li	a0,1
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	ae650513          	addi	a0,a0,-1306 # 7ae0 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	aca50513          	addi	a0,a0,-1334 # 7ae0 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	afe50513          	addi	a0,a0,-1282 # 7b28 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	ae650513          	addi	a0,a0,-1306 # 7b28 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	ad250513          	addi	a0,a0,-1326 # 7b28 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	abe50513          	addi	a0,a0,-1346 # 7b28 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	aaa58593          	addi	a1,a1,-1366 # 7b28 <malloc+0x1b14>
    4086:	00002517          	auipc	a0,0x2
    408a:	2a250513          	addi	a0,a0,674 # 6328 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	a4650513          	addi	a0,a0,-1466 # 7ae0 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	78850513          	addi	a0,a0,1928 # 6838 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    40ca:	77250513          	addi	a0,a0,1906 # 6838 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	0e658593          	addi	a1,a1,230 # 61c0 <malloc+0x1ac>
  ...
  close(fd);
    ...
    410a:	9e250513          	addi	a0,a0,-1566 # 7ae8 <malloc+0x1ad4>
    410e:	00002097          	auipc	ra,0x2
    4112:	e48080e7          	jalr	-440(ra) # 5f56 <printf>
    exit(1);
    4116:	4505                	li	a0,1
    ...
    4126:	9e650513          	addi	a0,a0,-1562 # 7b08 <malloc+0x1af4>
    412a:	00002097          	auipc	ra,0x2
    412e:	e2c080e7          	jalr	-468(ra) # 5f56 <printf>
    exit(1);
    4132:	4505                	li	a0,1
    ...
    4142:	9fa50513          	addi	a0,a0,-1542 # 7b38 <malloc+0x1b24>
    4146:	00002097          	auipc	ra,0x2
    414a:	e10080e7          	jalr	-496(ra) # 5f56 <printf>
    exit(1);
    414e:	4505                	li	a0,1
    ...
    415e:	9de50513          	addi	a0,a0,-1570 # 7b38 <malloc+0x1b24>
    4162:	00002097          	auipc	ra,0x2
    4166:	df4080e7          	jalr	-524(ra) # 5f56 <printf>
    exit(1);
    416a:	4505                	li	a0,1
    ...
    417a:	9ea50513          	addi	a0,a0,-1558 # 7b60 <malloc+0x1b4c>
    417e:	00002097          	auipc	ra,0x2
    4182:	dd8080e7          	jalr	-552(ra) # 5f56 <printf>
    exit(1);
    4186:	4505                	li	a0,1
    ...
    4196:	9f650513          	addi	a0,a0,-1546 # 7b88 <malloc+0x1b74>
    419a:	00002097          	auipc	ra,0x2
    419e:	dbc080e7          	jalr	-580(ra) # 5f56 <printf>
    exit(1);
    41a2:	4505                	li	a0,1
    ...
    41b2:	a0250513          	addi	a0,a0,-1534 # 7bb0 <malloc+0x1b9c>
    41b6:	00002097          	auipc	ra,0x2
    41ba:	da0080e7          	jalr	-608(ra) # 5f56 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ce:	a0e50513          	addi	a0,a0,-1522 # 7bd8 <malloc+0x1bc4>
    41d2:	00002097          	auipc	ra,0x2
    41d6:	d84080e7          	jalr	-636(ra) # 5f56 <printf>
    exit(1);
    41da:	4505                	li	a0,1
    ...
    41ea:	a1250513          	addi	a0,a0,-1518 # 7bf8 <malloc+0x1be4>
    41ee:	00002097          	auipc	ra,0x2
    41f2:	d68080e7          	jalr	-664(ra) # 5f56 <printf>
    exit(1);
    41f6:	4505                	li	a0,1
    ...
    4206:	a1e50513          	addi	a0,a0,-1506 # 7c20 <malloc+0x1c0c>
    420a:	00002097          	auipc	ra,0x2
    420e:	d4c080e7          	jalr	-692(ra) # 5f56 <printf>
    exit(1);
    4212:	4505                	li	a0,1
...
000000000000421c <iref>:
{
    ...
    423a:	a02a0a13          	addi	s4,s4,-1534 # 7c38 <malloc+0x1c24>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	50248493          	addi	s1,s1,1282 # 7740 <malloc+0x172c>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	0e2a8a93          	addi	s5,s5,226 # 6328 <malloc+0x314>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	8e298993          	addi	s3,s3,-1822 # 7b30 <malloc+0x1b1c>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	9e650513          	addi	a0,a0,-1562 # 7c40 <malloc+0x1c2c>
    4262:	00002097          	auipc	ra,0x2
    4266:	cf4080e7          	jalr	-780(ra) # 5f56 <printf>
      exit(1);
    426a:	4505                	li	a0,1
    ...
    427a:	9e250513          	addi	a0,a0,-1566 # 7c58 <malloc+0x1c44>
    427e:	00002097          	auipc	ra,0x2
    4282:	cd8080e7          	jalr	-808(ra) # 5f56 <printf>
      exit(1);
    4286:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	15698993          	addi	s3,s3,342 # 7460 <malloc+0x144c>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	92690913          	addi	s2,s2,-1754 # 7c38 <malloc+0x1c24>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	0d650513          	addi	a0,a0,214 # 7408 <malloc+0x13f4>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	90e50513          	addi	a0,a0,-1778 # 7c70 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    438a:	8ea50513          	addi	a0,a0,-1814 # 7c70 <malloc+0x1c5c>
    ...
    43a0:	8f450513          	addi	a0,a0,-1804 # 7c90 <malloc+0x1c7c>
    43a4:	00002097          	auipc	ra,0x2
    43a8:	bb2080e7          	jalr	-1102(ra) # 5f56 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
    ...
    43bc:	8c050513          	addi	a0,a0,-1856 # 7c78 <malloc+0x1c64>
    43c0:	00002097          	auipc	ra,0x2
    43c4:	b96080e7          	jalr	-1130(ra) # 5f56 <printf>
    exit(1);
    43c8:	4505                	li	a0,1
    ...
    43d8:	60450513          	addi	a0,a0,1540 # 69d8 <malloc+0x9c4>
    43dc:	00002097          	auipc	ra,0x2
    43e0:	b7a080e7          	jalr	-1158(ra) # 5f56 <printf>
    exit(1);
    43e4:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	86e50513          	addi	a0,a0,-1938 # 7c70 <malloc+0x1c5c>
    ...
    441a:	7b250513          	addi	a0,a0,1970 # 6bc8 <malloc+0xbb4>
    441e:	00002097          	auipc	ra,0x2
    4422:	b38080e7          	jalr	-1224(ra) # 5f56 <printf>
    exit(1);
    4426:	4505                	li	a0,1
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	86450513          	addi	a0,a0,-1948 # 7cb8 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	83850513          	addi	a0,a0,-1992 # 7cb8 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    44bc:	6e050513          	addi	a0,a0,1760 # 6b98 <malloc+0xb84>
    44c0:	00002097          	auipc	ra,0x2
    44c4:	a96080e7          	jalr	-1386(ra) # 5f56 <printf>
    exit(1);
    44c8:	4505                	li	a0,1
    ...
    44d6:	7e648493          	addi	s1,s1,2022 # 7cb8 <malloc+0x1ca4>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	45e50513          	addi	a0,a0,1118 # 69d8 <malloc+0x9c4>
    4582:	00002097          	auipc	ra,0x2
    4586:	9d4080e7          	jalr	-1580(ra) # 5f56 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	72850513          	addi	a0,a0,1832 # 7cc8 <malloc+0x1cb4>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	9ae080e7          	jalr	-1618(ra) # 5f56 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5b850513          	addi	a0,a0,1464 # 6b98 <malloc+0xb84>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	96e080e7          	jalr	-1682(ra) # 5f56 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4612:	3ca50513          	addi	a0,a0,970 # 69d8 <malloc+0x9c4>
    4616:	00002097          	auipc	ra,0x2
    461a:	940080e7          	jalr	-1728(ra) # 5f56 <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b6e58593          	addi	a1,a1,-1170 # 61c0 <malloc+0x1ac>
    ...
    4680:	35c50513          	addi	a0,a0,860 # 69d8 <malloc+0x9c4>
    4684:	00002097          	auipc	ra,0x2
    4688:	8d2080e7          	jalr	-1838(ra) # 5f56 <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	65050513          	addi	a0,a0,1616 # 7ce8 <malloc+0x1cd4>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	8b6080e7          	jalr	-1866(ra) # 5f56 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46bc:	b4058593          	addi	a1,a1,-1216 # c1f8 <buf>
    ...
    46d8:	62c50513          	addi	a0,a0,1580 # 7d00 <malloc+0x1cec>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	87a080e7          	jalr	-1926(ra) # 5f56 <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	61850513          	addi	a0,a0,1560 # 7d18 <malloc+0x1d04>
    4708:	00002097          	auipc	ra,0x2
    470c:	84e080e7          	jalr	-1970(ra) # 5f56 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	5fa50513          	addi	a0,a0,1530 # 7d28 <malloc+0x1d14>
    4736:	00002097          	auipc	ra,0x2
    473a:	820080e7          	jalr	-2016(ra) # 5f56 <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	22a50513          	addi	a0,a0,554 # 69d8 <malloc+0x9c4>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	7a0080e7          	jalr	1952(ra) # 5f56 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	39650513          	addi	a0,a0,918 # 6b60 <malloc+0xb4c>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	784080e7          	jalr	1924(ra) # 5f56 <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	2a050513          	addi	a0,a0,672 # 6ae0 <malloc+0xacc>
    4848:	00001097          	auipc	ra,0x1
    484c:	70e080e7          	jalr	1806(ra) # 5f56 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	94c58593          	addi	a1,a1,-1716 # 61c0 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	40050513          	addi	a0,a0,1024 # 7d38 <malloc+0x1d24>
    4940:	00001097          	auipc	ra,0x1
    4944:	616080e7          	jalr	1558(ra) # 5f56 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	08450513          	addi	a0,a0,132 # 69d8 <malloc+0x9c4>
    495c:	00001097          	auipc	ra,0x1
    4960:	5fa080e7          	jalr	1530(ra) # 5f56 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f0df8>
    ...
    49a4:	3b850513          	addi	a0,a0,952 # 7d58 <malloc+0x1d44>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	5ae080e7          	jalr	1454(ra) # 5f56 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	60a080e7          	jalr	1546(ra) # 6014 <malloc>
    ...
    4a48:	34450513          	addi	a0,a0,836 # 7d88 <malloc+0x1d74>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	50a080e7          	jalr	1290(ra) # 5f56 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2be50513          	addi	a0,a0,702 # 7db8 <malloc+0x1da4>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	454080e7          	jalr	1108(ra) # 5f56 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	2ca50513          	addi	a0,a0,714 # 7de0 <malloc+0x1dcc>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	438080e7          	jalr	1080(ra) # 5f56 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	24e50513          	addi	a0,a0,590 # 7da8 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	26650513          	addi	a0,a0,614 # 7e00 <malloc+0x1dec>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	3b4080e7          	jalr	948(ra) # 5f56 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	1d250513          	addi	a0,a0,466 # 7da8 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	22c50513          	addi	a0,a0,556 # 7e28 <malloc+0x1e14>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	352080e7          	jalr	850(ra) # 5f56 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	4b678793          	addi	a5,a5,1206 # 60f8 <malloc+0xe4>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	4b278793          	addi	a5,a5,1202 # 6100 <malloc+0xec>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	4ae78793          	addi	a5,a5,1198 # 6108 <malloc+0xf4>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	4aa78793          	addi	a5,a5,1194 # 6110 <malloc+0xfc>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4cbe:	00007a17          	auipc	s4,0x7
    4cc2:	53aa0a13          	addi	s4,s4,1338 # c1f8 <buf>
    4cc6:	00007a97          	auipc	s5,0x7
    4cca:	533a8a93          	addi	s5,s5,1331 # c1f9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	10250513          	addi	a0,a0,258 # 6de0 <malloc+0xdcc>
    4ce6:	00001097          	auipc	ra,0x1
    4cea:	270080e7          	jalr	624(ra) # 5f56 <printf>
      exit(1);
    4cee:	4505                	li	a0,1
    ...
    4d14:	00007517          	auipc	a0,0x7
    4d18:	4e450513          	addi	a0,a0,1252 # c1f8 <buf>
    4d1c:	00001097          	auipc	ra,0x1
    4d20:	cae080e7          	jalr	-850(ra) # 59ca <memset>
    4d24:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    4d26:	00007997          	auipc	s3,0x7
    4d2a:	4d298993          	addi	s3,s3,1234 # c1f8 <buf>
    ...
    4d5e:	0e650513          	addi	a0,a0,230 # 7e40 <malloc+0x1e2c>
    4d62:	00001097          	auipc	ra,0x1
    4d66:	1f4080e7          	jalr	500(ra) # 5f56 <printf>
        exit(1);
    4d6a:	4505                	li	a0,1
    ...
    4d78:	0dc50513          	addi	a0,a0,220 # 7e50 <malloc+0x1e3c>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	1da080e7          	jalr	474(ra) # 5f56 <printf>
          exit(1);
    4d84:	4505                	li	a0,1
    ...
    4da0:	0cc50513          	addi	a0,a0,204 # 7e68 <malloc+0x1e54>
    4da4:	00001097          	auipc	ra,0x1
    4da8:	1b2080e7          	jalr	434(ra) # 5f56 <printf>
          exit(1);
    4dac:	4505                	li	a0,1
    ...
    4dcc:	00007797          	auipc	a5,0x7
    4dd0:	42c78793          	addi	a5,a5,1068 # c1f8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	04e50513          	addi	a0,a0,78 # 7e78 <malloc+0x1e64>
    4e32:	00001097          	auipc	ra,0x1
    4e36:	124080e7          	jalr	292(ra) # 5f56 <printf>
      exit(1);
    4e3a:	4505                	li	a0,1
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	004b8b93          	addi	s7,s7,4 # 7e90 <malloc+0x1e7c>
  for(i = 0; i < N; i++){
    ...
    4ed2:	fca50513          	addi	a0,a0,-54 # 7e98 <malloc+0x1e84>
    4ed6:	00001097          	auipc	ra,0x1
    4eda:	080080e7          	jalr	128(ra) # 5f56 <printf>
        exit(1);
    4ede:	4505                	li	a0,1
    ...
    4ef0:	fa450513          	addi	a0,a0,-92 # 7e90 <malloc+0x1e7c>
  ...
  fd = open(".", 0);
    ...
    4f28:	91450513          	addi	a0,a0,-1772 # 6838 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	f1e50513          	addi	a0,a0,-226 # 7eb8 <malloc+0x1ea4>
    4fa2:	00001097          	auipc	ra,0x1
    4fa6:	fb4080e7          	jalr	-76(ra) # 5f56 <printf>
        exit(1);
    4faa:	4505                	li	a0,1
    ...
    4fbe:	f1e50513          	addi	a0,a0,-226 # 7ed8 <malloc+0x1ec4>
    4fc2:	00001097          	auipc	ra,0x1
    4fc6:	f94080e7          	jalr	-108(ra) # 5f56 <printf>
        exit(1);
    4fca:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	f0e50513          	addi	a0,a0,-242 # 7f00 <malloc+0x1eec>
    4ffa:	00001097          	auipc	ra,0x1
    4ffe:	f5c080e7          	jalr	-164(ra) # 5f56 <printf>
    exit(1);
    5002:	4505                	li	a0,1
    ...
    5012:	9ca50513          	addi	a0,a0,-1590 # 69d8 <malloc+0x9c4>
    5016:	00001097          	auipc	ra,0x1
    501a:	f40080e7          	jalr	-192(ra) # 5f56 <printf>
      exit(1);
    501e:	4505                	li	a0,1
...
00000000000051bc <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    51f6:	4481                	li	s1,0
    memset(buf, i, SZ);
    51f8:	00007917          	auipc	s2,0x7
    51fc:	00090913          	mv	s2,s2
  for(i = 0; i < N; i++){
    5200:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	cf850513          	addi	a0,a0,-776 # 7f38 <malloc+0x1f24>
  ...
  for(i = 0; ; i++){
    5254:	4481                	li	s1,0
    cc = read(fd, buf, SZ/2);
    5256:	00007917          	auipc	s2,0x7
    525a:	fa290913          	addi	s2,s2,-94 # c1f8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    52a8:	ca450513          	addi	a0,a0,-860 # 7f48 <malloc+0x1f34>
    52ac:	00001097          	auipc	ra,0x1
    52b0:	caa080e7          	jalr	-854(ra) # 5f56 <printf>
    exit(1);
    52b4:	4505                	li	a0,1
    ...
    52c4:	ca850513          	addi	a0,a0,-856 # 7f68 <malloc+0x1f54>
    52c8:	00001097          	auipc	ra,0x1
    52cc:	c8e080e7          	jalr	-882(ra) # 5f56 <printf>
      exit(1);
    52d0:	4505                	li	a0,1
    ...
    52e0:	cac50513          	addi	a0,a0,-852 # 7f88 <malloc+0x1f74>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	c72080e7          	jalr	-910(ra) # 5f56 <printf>
    exit(1);
    52ec:	4505                	li	a0,1
    ...
    52fc:	cb050513          	addi	a0,a0,-848 # 7fa8 <malloc+0x1f94>
    5300:	00001097          	auipc	ra,0x1
    5304:	c56080e7          	jalr	-938(ra) # 5f56 <printf>
      exit(1);
    5308:	4505                	li	a0,1
    ...
    5318:	cb450513          	addi	a0,a0,-844 # 7fc8 <malloc+0x1fb4>
    531c:	00001097          	auipc	ra,0x1
    5320:	c3a080e7          	jalr	-966(ra) # 5f56 <printf>
      exit(1);
    5324:	4505                	li	a0,1
    ...
    5334:	cb050513          	addi	a0,a0,-848 # 7fe0 <malloc+0x1fcc>
    5338:	00001097          	auipc	ra,0x1
    533c:	c1e080e7          	jalr	-994(ra) # 5f56 <printf>
      exit(1);
    5340:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5362:	bda50513          	addi	a0,a0,-1062 # 7f38 <malloc+0x1f24>
    ...
    5386:	c7e50513          	addi	a0,a0,-898 # 8000 <malloc+0x1fec>
    538a:	00001097          	auipc	ra,0x1
    538e:	bcc080e7          	jalr	-1076(ra) # 5f56 <printf>
    exit(1);
    5392:	4505                	li	a0,1
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	c6650513          	addi	a0,a0,-922 # 8020 <malloc+0x200c>
    53c2:	00001097          	auipc	ra,0x1
    53c6:	b94080e7          	jalr	-1132(ra) # 5f56 <printf>
  for(nfiles = 0; ; nfiles++){
    53ca:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53de:	c56c8c93          	addi	s9,s9,-938 # 8030 <malloc+0x201c>
    int total = 0;
    53e2:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    53e4:	00007a17          	auipc	s4,0x7
    53e8:	e14a0a13          	addi	s4,s4,-492 # c1f8 <buf>
    name[0] = 'f';
    ...
    5436:	b24080e7          	jalr	-1244(ra) # 5f56 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5458:	bec50513          	addi	a0,a0,-1044 # 8040 <malloc+0x202c>
    545c:	00001097          	auipc	ra,0x1
    5460:	afa080e7          	jalr	-1286(ra) # 5f56 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	b9650513          	addi	a0,a0,-1130 # 8060 <malloc+0x204c>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	a84080e7          	jalr	-1404(ra) # 5f56 <printf>
}
    ...
    551e:	b3650513          	addi	a0,a0,-1226 # 8050 <malloc+0x203c>
    5522:	00001097          	auipc	ra,0x1
    5526:	a34080e7          	jalr	-1484(ra) # 5f56 <printf>
    close(fd);
    552a:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	b2c50513          	addi	a0,a0,-1236 # 8078 <malloc+0x2064>
    5554:	00001097          	auipc	ra,0x1
    5558:	a02080e7          	jalr	-1534(ra) # 5f56 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5580:	b2450513          	addi	a0,a0,-1244 # 80a0 <malloc+0x208c>
    5584:	00001097          	auipc	ra,0x1
    5588:	9d2080e7          	jalr	-1582(ra) # 5f56 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a4:	ae850513          	addi	a0,a0,-1304 # 8088 <malloc+0x2074>
    55a8:	00001097          	auipc	ra,0x1
    55ac:	9ae080e7          	jalr	-1618(ra) # 5f56 <printf>
    exit(1);
    55b0:	4505                	li	a0,1
    ...
    55cc:	ae050513          	addi	a0,a0,-1312 # 80a8 <malloc+0x2094>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	986080e7          	jalr	-1658(ra) # 5f56 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	a9850513          	addi	a0,a0,-1384 # 80b0 <malloc+0x209c>
    5620:	00001097          	auipc	ra,0x1
    5624:	936080e7          	jalr	-1738(ra) # 5f56 <printf>
        return 1;
    5628:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	b4e98993          	addi	s3,s3,-1202 # 61c0 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	a6450513          	addi	a0,a0,-1436 # 8108 <malloc+0x20f4>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	8aa080e7          	jalr	-1878(ra) # 5f56 <printf>
        exit(1);
    56b4:	4505                	li	a0,1
    ...
    56c2:	a0a50513          	addi	a0,a0,-1526 # 80c8 <malloc+0x20b4>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	890080e7          	jalr	-1904(ra) # 5f56 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
    ...
    56dc:	a1050513          	addi	a0,a0,-1520 # 80e8 <malloc+0x20d4>
    56e0:	00001097          	auipc	ra,0x1
    56e4:	876080e7          	jalr	-1930(ra) # 5f56 <printf>
    exit(1);
    56e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    572a:	a0250513          	addi	a0,a0,-1534 # 8128 <malloc+0x2114>
    572e:	00001097          	auipc	ra,0x1
    5732:	828080e7          	jalr	-2008(ra) # 5f56 <printf>
      exit(1);
    5736:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	9c0b8b93          	addi	s7,s7,-1600 # 8148 <malloc+0x2134>
    int free0 = countfree();
    int free1 = 0;
    if (runtests(quicktests, justone)) {
    5790:	00003b17          	auipc	s6,0x3
    5794:	e00b0b13          	addi	s6,s6,-512 # 8590 <quicktests>
      if(continuous != 2) {
    5798:	4a89                	li	s5,2
          return 1;
        }
    ...
    579e:	9e6c8c93          	addi	s9,s9,-1562 # 8180 <malloc+0x216c>
      if (runtests(slowtests, justone)) {
    57a2:	00003c17          	auipc	s8,0x3
    57a6:	1bec0c13          	addi	s8,s8,446 # 8960 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	9b6d0d13          	addi	s10,s10,-1610 # 8160 <malloc+0x214c>
    57b2:	a839                	j	57d0 <drivetests+0x6a>
    57b4:	856a                	mv	a0,s10
    57b6:	00000097          	auipc	ra,0x0
    57ba:	7a0080e7          	jalr	1952(ra) # 5f56 <printf>
    ...
    57d6:	784080e7          	jalr	1924(ra) # 5f56 <printf>
    int free0 = countfree();
    ...
    5826:	734080e7          	jalr	1844(ra) # 5f56 <printf>
      if(continuous != 2) {
    ...
    5836:	724080e7          	jalr	1828(ra) # 5f56 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	91058593          	addi	a1,a1,-1776 # 81b0 <malloc+0x219c>
    ...
    58ba:	95258593          	addi	a1,a1,-1710 # 8208 <malloc+0x21f4>
    ...
    58d0:	93458593          	addi	a1,a1,-1740 # 8200 <malloc+0x21ec>
  ...
  int continuous = 0;
    ...
    58fc:	8c050513          	addi	a0,a0,-1856 # 81b8 <malloc+0x21a4>
    5900:	00000097          	auipc	ra,0x0
    5904:	656080e7          	jalr	1622(ra) # 5f56 <printf>
    exit(1);
    5908:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	8c450513          	addi	a0,a0,-1852 # 81e8 <malloc+0x21d4>
    592c:	00000097          	auipc	ra,0x0
    5930:	62a080e7          	jalr	1578(ra) # 5f56 <printf>
  exit(0);
    5934:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c7e:	1101                	addi	sp,sp,-32
    5c80:	ec06                	sd	ra,24(sp)
    5c82:	e822                	sd	s0,16(sp)
    5c84:	1000                	addi	s0,sp,32
    5c86:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c8a:	4605                	li	a2,1
    5c8c:	fef40593          	addi	a1,s0,-17
    5c90:	00000097          	auipc	ra,0x0
    5c94:	f56080e7          	jalr	-170(ra) # 5be6 <write>
}
    5c98:	60e2                	ld	ra,24(sp)
    5c9a:	6442                	ld	s0,16(sp)
    5c9c:	6105                	addi	sp,sp,32
    5c9e:	8082                	ret

0000000000005ca0 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5cb0:	c299                	beqz	a3,5cb6 <printint+0x16>
    5cb2:	0805c863          	bltz	a1,5d42 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5cb6:	2581                	sext.w	a1,a1
  neg = 0;
    5cb8:	4881                	li	a7,0
    5cba:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5cc0:	2601                	sext.w	a2,a2
    5cc2:	00003517          	auipc	a0,0x3
    5cc6:	8b650513          	addi	a0,a0,-1866 # 8578 <digits>
    5cca:	883a                	mv	a6,a4
    5ccc:	2705                	addiw	a4,a4,1
    5cce:	02c5f7bb          	remuw	a5,a1,a2
    5cd2:	1782                	slli	a5,a5,0x20
    5cd4:	9381                	srli	a5,a5,0x20
    5cd6:	97aa                	add	a5,a5,a0
    5cd8:	0007c783          	lbu	a5,0(a5)
    5cdc:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5ce0:	0005879b          	sext.w	a5,a1
    5ce4:	02c5d5bb          	divuw	a1,a1,a2
    5ce8:	0685                	addi	a3,a3,1
    5cea:	fec7f0e3          	bgeu	a5,a2,5cca <printint+0x2a>
  if(neg)
    5cee:	00088b63          	beqz	a7,5d04 <printint+0x64>
    buf[i++] = '-';
    5cf2:	fd040793          	addi	a5,s0,-48
    5cf6:	973e                	add	a4,a4,a5
    5cf8:	02d00793          	li	a5,45
    5cfc:	fef70823          	sb	a5,-16(a4)
    5d00:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d04:	02e05863          	blez	a4,5d34 <printint+0x94>
    5d08:	fc040793          	addi	a5,s0,-64
    5d0c:	00e78933          	add	s2,a5,a4
    5d10:	fff78993          	addi	s3,a5,-1
    5d14:	99ba                	add	s3,s3,a4
    5d16:	377d                	addiw	a4,a4,-1
    5d18:	1702                	slli	a4,a4,0x20
    5d1a:	9301                	srli	a4,a4,0x20
    5d1c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d20:	fff94583          	lbu	a1,-1(s2)
    5d24:	8526                	mv	a0,s1
    5d26:	00000097          	auipc	ra,0x0
    5d2a:	f58080e7          	jalr	-168(ra) # 5c7e <putc>
  while(--i >= 0)
    5d2e:	197d                	addi	s2,s2,-1
    5d30:	ff3918e3          	bne	s2,s3,5d20 <printint+0x80>
}
    5d34:	70e2                	ld	ra,56(sp)
    5d36:	7442                	ld	s0,48(sp)
    5d38:	74a2                	ld	s1,40(sp)
    5d3a:	7902                	ld	s2,32(sp)
    5d3c:	69e2                	ld	s3,24(sp)
    5d3e:	6121                	addi	sp,sp,64
    5d40:	8082                	ret
    x = -xx;
    5d42:	40b005bb          	negw	a1,a1
    neg = 1;
    5d46:	4885                	li	a7,1
    x = -xx;
    5d48:	bf8d                	j	5cba <printint+0x1a>

0000000000005d4a <vprintf>:
}
...
{
    5d4a:	7119                	addi	sp,sp,-128
    5d4c:	fc86                	sd	ra,120(sp)
    5d4e:	f8a2                	sd	s0,112(sp)
    5d50:	f4a6                	sd	s1,104(sp)
    5d52:	f0ca                	sd	s2,96(sp)
    5d54:	ecce                	sd	s3,88(sp)
    5d56:	e8d2                	sd	s4,80(sp)
    5d58:	e4d6                	sd	s5,72(sp)
    5d5a:	e0da                	sd	s6,64(sp)
    5d5c:	fc5e                	sd	s7,56(sp)
    5d5e:	f862                	sd	s8,48(sp)
    5d60:	f466                	sd	s9,40(sp)
    5d62:	f06a                	sd	s10,32(sp)
    5d64:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5d68:	0005c903          	lbu	s2,0(a1)
    5d6c:	18090f63          	beqz	s2,5f0a <vprintf+0x1c0>
    5d70:	8aaa                	mv	s5,a0
    5d72:	8b32                	mv	s6,a2
    5d74:	00158493          	addi	s1,a1,1
  state = 0;
    5d78:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d7a:	02500a13          	li	s4,37
      if(c == 'd'){
    5d7e:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5d82:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5d86:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5d8a:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d8e:	00002b97          	auipc	s7,0x2
    5d92:	7eab8b93          	addi	s7,s7,2026 # 8578 <digits>
    5d96:	a839                	j	5db4 <vprintf+0x6a>
        putc(fd, c);
    5d98:	85ca                	mv	a1,s2
    5d9a:	8556                	mv	a0,s5
    5d9c:	00000097          	auipc	ra,0x0
    5da0:	ee2080e7          	jalr	-286(ra) # 5c7e <putc>
    5da4:	a019                	j	5daa <vprintf+0x60>
    } else if(state == '%'){
    5da6:	01498f63          	beq	s3,s4,5dc4 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5daa:	0485                	addi	s1,s1,1
    5dac:	fff4c903          	lbu	s2,-1(s1)
    5db0:	14090d63          	beqz	s2,5f0a <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5db4:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5db8:	fe0997e3          	bnez	s3,5da6 <vprintf+0x5c>
      if(c == '%'){
    5dbc:	fd479ee3          	bne	a5,s4,5d98 <vprintf+0x4e>
        state = '%';
    5dc0:	89be                	mv	s3,a5
    5dc2:	b7e5                	j	5daa <vprintf+0x60>
      if(c == 'd'){
    5dc4:	05878063          	beq	a5,s8,5e04 <vprintf+0xba>
      } else if(c == 'l') {
    5dc8:	05978c63          	beq	a5,s9,5e20 <vprintf+0xd6>
      } else if(c == 'x') {
    5dcc:	07a78863          	beq	a5,s10,5e3c <vprintf+0xf2>
      } else if(c == 'p') {
    5dd0:	09b78463          	beq	a5,s11,5e58 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5dd4:	07300713          	li	a4,115
    5dd8:	0ce78663          	beq	a5,a4,5ea4 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5ddc:	06300713          	li	a4,99
    5de0:	0ee78e63          	beq	a5,a4,5edc <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5de4:	11478863          	beq	a5,s4,5ef4 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5df0:	e92080e7          	jalr	-366(ra) # 5c7e <putc>
        putc(fd, c);
    5df4:	85ca                	mv	a1,s2
    5df6:	8556                	mv	a0,s5
    5df8:	00000097          	auipc	ra,0x0
    5dfc:	e86080e7          	jalr	-378(ra) # 5c7e <putc>
      }
      state = 0;
    5e00:	4981                	li	s3,0
    5e02:	b765                	j	5daa <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5e16:	e8e080e7          	jalr	-370(ra) # 5ca0 <printint>
    5e1a:	8b4a                	mv	s6,s2
      state = 0;
    5e1c:	4981                	li	s3,0
    5e1e:	b771                	j	5daa <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5e32:	e72080e7          	jalr	-398(ra) # 5ca0 <printint>
    5e36:	8b4a                	mv	s6,s2
      state = 0;
    5e38:	4981                	li	s3,0
    5e3a:	bf85                	j	5daa <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5e4e:	e56080e7          	jalr	-426(ra) # 5ca0 <printint>
    5e52:	8b4a                	mv	s6,s2
      state = 0;
    5e54:	4981                	li	s3,0
    5e56:	bf91                	j	5daa <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5e6e:	e14080e7          	jalr	-492(ra) # 5c7e <putc>
  putc(fd, 'x');
    5e72:	85ea                	mv	a1,s10
    5e74:	8556                	mv	a0,s5
    5e76:	00000097          	auipc	ra,0x0
    5e7a:	e08080e7          	jalr	-504(ra) # 5c7e <putc>
    5e7e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e80:	03c9d793          	srli	a5,s3,0x3c
    5e84:	97de                	add	a5,a5,s7
    5e86:	0007c583          	lbu	a1,0(a5)
    5e8a:	8556                	mv	a0,s5
    5e8c:	00000097          	auipc	ra,0x0
    5e90:	df2080e7          	jalr	-526(ra) # 5c7e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e94:	0992                	slli	s3,s3,0x4
    5e96:	397d                	addiw	s2,s2,-1
    5e98:	fe0914e3          	bnez	s2,5e80 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5e9c:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5ea0:	4981                	li	s3,0
    5ea2:	b721                	j	5daa <vprintf+0x60>
        s = va_arg(ap, char*);
    5ea4:	008b0993          	addi	s3,s6,8
    5ea8:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5eac:	02090163          	beqz	s2,5ece <vprintf+0x184>
        while(*s != 0){
    5eb0:	00094583          	lbu	a1,0(s2)
    5eb4:	c9a1                	beqz	a1,5f04 <vprintf+0x1ba>
          putc(fd, *s);
    5eb6:	8556                	mv	a0,s5
    5eb8:	00000097          	auipc	ra,0x0
    5ebc:	dc6080e7          	jalr	-570(ra) # 5c7e <putc>
          s++;
    5ec0:	0905                	addi	s2,s2,1
        while(*s != 0){
    5ec2:	00094583          	lbu	a1,0(s2)
    5ec6:	f9e5                	bnez	a1,5eb6 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5ec8:	8b4e                	mv	s6,s3
      state = 0;
    5eca:	4981                	li	s3,0
    5ecc:	bdf9                	j	5daa <vprintf+0x60>
          s = "(null)";
    5ece:	00002917          	auipc	s2,0x2
    5ed2:	6a290913          	addi	s2,s2,1698 # 8570 <malloc+0x255c>
        while(*s != 0){
    5ed6:	02800593          	li	a1,40
    5eda:	bff1                	j	5eb6 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5edc:	008b0913          	addi	s2,s6,8
    5ee0:	000b4583          	lbu	a1,0(s6)
    5ee4:	8556                	mv	a0,s5
    5ee6:	00000097          	auipc	ra,0x0
    5eea:	d98080e7          	jalr	-616(ra) # 5c7e <putc>
    5eee:	8b4a                	mv	s6,s2
      state = 0;
    5ef0:	4981                	li	s3,0
    5ef2:	bd65                	j	5daa <vprintf+0x60>
        putc(fd, c);
    5ef4:	85d2                	mv	a1,s4
    5ef6:	8556                	mv	a0,s5
    5ef8:	00000097          	auipc	ra,0x0
    5efc:	d86080e7          	jalr	-634(ra) # 5c7e <putc>
      state = 0;
    5f00:	4981                	li	s3,0
    5f02:	b565                	j	5daa <vprintf+0x60>
        s = va_arg(ap, char*);
    5f04:	8b4e                	mv	s6,s3
      state = 0;
    5f06:	4981                	li	s3,0
    5f08:	b54d                	j	5daa <vprintf+0x60>
    }
  }
}
    5f0a:	70e6                	ld	ra,120(sp)
    5f0c:	7446                	ld	s0,112(sp)
    5f0e:	74a6                	ld	s1,104(sp)
    5f10:	7906                	ld	s2,96(sp)
    5f12:	69e6                	ld	s3,88(sp)
    5f14:	6a46                	ld	s4,80(sp)
    5f16:	6aa6                	ld	s5,72(sp)
    5f18:	6b06                	ld	s6,64(sp)
    5f1a:	7be2                	ld	s7,56(sp)
    5f1c:	7c42                	ld	s8,48(sp)
    5f1e:	7ca2                	ld	s9,40(sp)
    5f20:	7d02                	ld	s10,32(sp)
    5f22:	6de2                	ld	s11,24(sp)
    5f24:	6109                	addi	sp,sp,128
    5f26:	8082                	ret

0000000000005f28 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f28:	715d                	addi	sp,sp,-80
    5f2a:	ec06                	sd	ra,24(sp)
    5f2c:	e822                	sd	s0,16(sp)
    5f2e:	1000                	addi	s0,sp,32
    5f30:	e010                	sd	a2,0(s0)
    5f32:	e414                	sd	a3,8(s0)
    5f34:	e818                	sd	a4,16(s0)
    5f36:	ec1c                	sd	a5,24(s0)
    5f38:	03043023          	sd	a6,32(s0)
    5f3c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f40:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f44:	8622                	mv	a2,s0
    5f46:	00000097          	auipc	ra,0x0
    5f4a:	e04080e7          	jalr	-508(ra) # 5d4a <vprintf>
}
    5f4e:	60e2                	ld	ra,24(sp)
    5f50:	6442                	ld	s0,16(sp)
    5f52:	6161                	addi	sp,sp,80
    5f54:	8082                	ret

0000000000005f56 <printf>:

void
printf(const char *fmt, ...)
{
    5f56:	711d                	addi	sp,sp,-96
    5f58:	ec06                	sd	ra,24(sp)
    5f5a:	e822                	sd	s0,16(sp)
    5f5c:	1000                	addi	s0,sp,32
    5f5e:	e40c                	sd	a1,8(s0)
    5f60:	e810                	sd	a2,16(s0)
    5f62:	ec14                	sd	a3,24(s0)
    5f64:	f018                	sd	a4,32(s0)
    5f66:	f41c                	sd	a5,40(s0)
    5f68:	03043823          	sd	a6,48(s0)
    5f6c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f70:	00840613          	addi	a2,s0,8
    5f74:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f78:	85aa                	mv	a1,a0
    5f7a:	4505                	li	a0,1
    5f7c:	00000097          	auipc	ra,0x0
    5f80:	dce080e7          	jalr	-562(ra) # 5d4a <vprintf>
}
    5f84:	60e2                	ld	ra,24(sp)
    5f86:	6442                	ld	s0,16(sp)
    5f88:	6125                	addi	sp,sp,96
    5f8a:	8082                	ret

0000000000005f8c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f8c:	1141                	addi	sp,sp,-16
    5f8e:	e422                	sd	s0,8(sp)
    5f90:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f92:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f96:	00003797          	auipc	a5,0x3
    5f9a:	a427b783          	ld	a5,-1470(a5) # 89d8 <freep>
    5f9e:	a805                	j	5fce <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fa0:	4618                	lw	a4,8(a2)
    5fa2:	9db9                	addw	a1,a1,a4
    5fa4:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fa8:	6398                	ld	a4,0(a5)
    5faa:	6318                	ld	a4,0(a4)
    5fac:	fee53823          	sd	a4,-16(a0)
    5fb0:	a091                	j	5ff4 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fb2:	ff852703          	lw	a4,-8(a0)
    5fb6:	9e39                	addw	a2,a2,a4
    5fb8:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5fba:	ff053703          	ld	a4,-16(a0)
    5fbe:	e398                	sd	a4,0(a5)
    5fc0:	a099                	j	6006 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fc2:	6398                	ld	a4,0(a5)
    5fc4:	00e7e463          	bltu	a5,a4,5fcc <free+0x40>
    5fc8:	00e6ea63          	bltu	a3,a4,5fdc <free+0x50>
{
    5fcc:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fce:	fed7fae3          	bgeu	a5,a3,5fc2 <free+0x36>
    5fd2:	6398                	ld	a4,0(a5)
    5fd4:	00e6e463          	bltu	a3,a4,5fdc <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fd8:	fee7eae3          	bltu	a5,a4,5fcc <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5fdc:	ff852583          	lw	a1,-8(a0)
    5fe0:	6390                	ld	a2,0(a5)
    5fe2:	02059713          	slli	a4,a1,0x20
    5fe6:	9301                	srli	a4,a4,0x20
    5fe8:	0712                	slli	a4,a4,0x4
    5fea:	9736                	add	a4,a4,a3
    5fec:	fae60ae3          	beq	a2,a4,5fa0 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5ff0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5ff4:	4790                	lw	a2,8(a5)
    5ff6:	02061713          	slli	a4,a2,0x20
    5ffa:	9301                	srli	a4,a4,0x20
    5ffc:	0712                	slli	a4,a4,0x4
    5ffe:	973e                	add	a4,a4,a5
    6000:	fae689e3          	beq	a3,a4,5fb2 <free+0x26>
  } else
    p->s.ptr = bp;
    6004:	e394                	sd	a3,0(a5)
  freep = p;
    6006:	00003717          	auipc	a4,0x3
    600a:	9cf73923          	sd	a5,-1582(a4) # 89d8 <freep>
}
    600e:	6422                	ld	s0,8(sp)
    6010:	0141                	addi	sp,sp,16
    6012:	8082                	ret

0000000000006014 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    6014:	7139                	addi	sp,sp,-64
    6016:	fc06                	sd	ra,56(sp)
    6018:	f822                	sd	s0,48(sp)
    601a:	f426                	sd	s1,40(sp)
    601c:	f04a                	sd	s2,32(sp)
    601e:	ec4e                	sd	s3,24(sp)
    6020:	e852                	sd	s4,16(sp)
    6022:	e456                	sd	s5,8(sp)
    6024:	e05a                	sd	s6,0(sp)
    6026:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6028:	02051493          	slli	s1,a0,0x20
    602c:	9081                	srli	s1,s1,0x20
    602e:	04bd                	addi	s1,s1,15
    6030:	8091                	srli	s1,s1,0x4
    6032:	0014899b          	addiw	s3,s1,1
    6036:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    6038:	00003517          	auipc	a0,0x3
    603c:	9a053503          	ld	a0,-1632(a0) # 89d8 <freep>
    6040:	c515                	beqz	a0,606c <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6042:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    6044:	4798                	lw	a4,8(a5)
    6046:	02977f63          	bgeu	a4,s1,6084 <malloc+0x70>
    604a:	8a4e                	mv	s4,s3
    604c:	0009871b          	sext.w	a4,s3
    6050:	6685                	lui	a3,0x1
    6052:	00d77363          	bgeu	a4,a3,6058 <malloc+0x44>
    6056:	6a05                	lui	s4,0x1
    6058:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    605c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    6060:	00003917          	auipc	s2,0x3
    6064:	97890913          	addi	s2,s2,-1672 # 89d8 <freep>
  if(p == (char*)-1)
    6068:	5afd                	li	s5,-1
    606a:	a88d                	j	60dc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    606c:	00009797          	auipc	a5,0x9
    6070:	18c78793          	addi	a5,a5,396 # f1f8 <base>
    6074:	00003717          	auipc	a4,0x3
    6078:	96f73223          	sd	a5,-1692(a4) # 89d8 <freep>
    607c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    607e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    6082:	b7e1                	j	604a <malloc+0x36>
      if(p->s.size == nunits)
    6084:	02e48b63          	beq	s1,a4,60ba <malloc+0xa6>
        p->s.size -= nunits;
    6088:	4137073b          	subw	a4,a4,s3
    608c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    608e:	1702                	slli	a4,a4,0x20
    6090:	9301                	srli	a4,a4,0x20
    6092:	0712                	slli	a4,a4,0x4
    6094:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6096:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    609a:	00003717          	auipc	a4,0x3
    609e:	92a73f23          	sd	a0,-1730(a4) # 89d8 <freep>
      return (void*)(p + 1);
    ...
    60be:	bff1                	j	609a <malloc+0x86>
  hp->s.size = nu;
    60c0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60c4:	0541                	addi	a0,a0,16
    60c6:	00000097          	auipc	ra,0x0
    60ca:	ec6080e7          	jalr	-314(ra) # 5f8c <free>
  return freep;
    60ce:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60d2:	d971                	beqz	a0,60a6 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60d4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60d6:	4798                	lw	a4,8(a5)
    60d8:	fa9776e3          	bgeu	a4,s1,6084 <malloc+0x70>
    if(p == freep)
    60dc:	00093703          	ld	a4,0(s2)
    60e0:	853e                	mv	a0,a5
    60e2:	fef719e3          	bne	a4,a5,60d4 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    60e6:	8552                	mv	a0,s4
    60e8:	00000097          	auipc	ra,0x0
    60ec:	b66080e7          	jalr	-1178(ra) # 5c4e <sbrk>
  if(p == (char*)-1)
    60f0:	fd5518e3          	bne	a0,s5,60c0 <malloc+0xac>
        return 0;
    60f4:	4501                	li	a0,0
    60f6:	bf45                	j	60a6 <malloc+0x92>
