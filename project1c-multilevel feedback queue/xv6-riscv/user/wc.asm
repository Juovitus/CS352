...
free(void *ap)
{
 ...
 7f2:	1ca7b783          	ld	a5,458(a5) # 9b8 <freep>
 ...
 820:	00e6ea63          	bltu	a3,a4,834 <free+0x50>
{
 ...
 862:	14f73d23          	sd	a5,346(a4) # 9b8 <freep>
}
 866:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 894:	12853503          	ld	a0,296(a0) # 9b8 <freep>
 ...
 8bc:	10090913          	addi	s2,s2,256 # 9b8 <freep>
  if(p == (char*)-1)
 8c0:	5afd                	li	s5,-1
 ...
 8d0:	0ef73623          	sd	a5,236(a4) # 9b8 <freep>
 8d4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8f6:	0ca73323          	sd	a0,198(a4) # 9b8 <freep>
      return (void*)(p + 1);
