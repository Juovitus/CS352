...
user/_logging:     file format elf64-littleriscv
...
int main(void){
  ...
  16:	3b2080e7          	jalr	946(ra) # 3c4 <nice>
    startlog();
  1a:	00000097          	auipc	ra,0x0
  1e:	39a080e7          	jalr	922(ra) # 3b4 <startlog>
    uint64 sizeLog = 0;
    if(fork() > 0){
  22:	00000097          	auipc	ra,0x0
  26:	2ea080e7          	jalr	746(ra) # 30c <fork>
  2a:	04a05863          	blez	a0,7a <main+0x7a>
  2e:	4499                	li	s1,6
        for(int i = 0; i < 6; i++){
         sleep(1);
  30:	4505                	li	a0,1
  32:	00000097          	auipc	ra,0x0
  36:	372080e7          	jalr	882(ra) # 3a4 <sleep>
        for(int i = 0; i < 6; i++){
  3a:	34fd                	addiw	s1,s1,-1
  3c:	f8f5                	bnez	s1,30 <main+0x30>
        }
        sizeLog = getlog(schedlog);
  3e:	00001517          	auipc	a0,0x1
  42:	84a50513          	addi	a0,a0,-1974 # 888 <schedlog>
  46:	00000097          	auipc	ra,0x0
  4a:	376080e7          	jalr	886(ra) # 3bc <getlog>
  4e:	89aa                	mv	s3,a0
    }
    for(int i = 0; i < sizeLog; i++){
  50:	c50d                	beqz	a0,7a <main+0x7a>
  52:	00001497          	auipc	s1,0x1
  56:	83648493          	addi	s1,s1,-1994 # 888 <schedlog>
  5a:	4901                	li	s2,0
        printf("ID: %d,  Time:  %d\n", schedlog[i].pid, schedlog[i].time);
  5c:	00000a17          	auipc	s4,0x0
  60:	7eca0a13          	addi	s4,s4,2028 # 848 <malloc+0xe6>
  64:	40d0                	lw	a2,4(s1)
  66:	408c                	lw	a1,0(s1)
  68:	8552                	mv	a0,s4
  6a:	00000097          	auipc	ra,0x0
  6e:	63a080e7          	jalr	1594(ra) # 6a4 <printf>
    for(int i = 0; i < sizeLog; i++){
  72:	0905                	addi	s2,s2,1
  74:	04a1                	addi	s1,s1,8
  76:	ff3917e3          	bne	s2,s3,64 <main+0x64>
    // printf("--------------------------------------------\n");
...
free(void *ap)
{
 ...
 6e8:	19c7b783          	ld	a5,412(a5) # 880 <freep>
 ...
 716:	00e6ea63          	bltu	a3,a4,72a <free+0x50>
{
 ...
 758:	12f73623          	sd	a5,300(a4) # 880 <freep>
}
 75c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78a:	0fa53503          	ld	a0,250(a0) # 880 <freep>
 ...
 7b2:	0d290913          	addi	s2,s2,210 # 880 <freep>
  if(p == (char*)-1)
 7b6:	5afd                	li	s5,-1
 7b8:	a88d                	j	82a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ba:	00000797          	auipc	a5,0x0
 7be:	3ee78793          	addi	a5,a5,1006 # ba8 <base>
 7c2:	00000717          	auipc	a4,0x0
 7c6:	0af73f23          	sd	a5,190(a4) # 880 <freep>
 7ca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ec:	08a73c23          	sd	a0,152(a4) # 880 <freep>
      return (void*)(p + 1);
